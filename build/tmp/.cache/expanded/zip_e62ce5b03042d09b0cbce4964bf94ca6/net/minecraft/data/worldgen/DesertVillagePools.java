...
public class DesertVillagePools {
   ...
   public static void bootstrap(BootstapContext<StructureTemplatePool> p_255787_) {
      HolderGetter<PlacedFeature> holdergetter = p_255787_.lookup(Registries.PLACED_FEATURE);
      ...
      HolderGetter<StructureProcessorList> holdergetter1 = p_255787_.lookup(Registries.PROCESSOR_LIST);
      ...
      HolderGetter<StructureTemplatePool> holdergetter2 = p_255787_.lookup(Registries.TEMPLATE_POOL);
