...
public class NetherFeatures {
   ...
   public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> p_256247_) {
      ...
      FeatureUtils.register(
         p_256247_, CRIMSON_FOREST_VEGETATION, Feature.NETHER_FOREST_VEGETATION, new NetherForestVegetationConfig(weightedstateprovider, 8, 4)
      );
      FeatureUtils.register(
         p_256247_, CRIMSON_FOREST_VEGETATION_BONEMEAL, Feature.NETHER_FOREST_VEGETATION, new NetherForestVegetationConfig(weightedstateprovider, 3, 1)
      );
      ...
      FeatureUtils.register(
         p_256247_, WARPED_FOREST_VEGETATION_BONEMEAL, Feature.NETHER_FOREST_VEGETATION, new NetherForestVegetationConfig(weightedstateprovider1, 3, 1)
      );
      FeatureUtils.register(
         p_256247_, NETHER_SPROUTS, Feature.NETHER_FOREST_VEGETATION, new NetherForestVegetationConfig(BlockStateProvider.simple(Blocks.NETHER_SPROUTS), 8, 4)
      );
      FeatureUtils.register(
         p_256247_,
