...
public class VegetationPlacements {
   ...
   public static void bootstrap(BootstapContext<PlacedFeature> p_255657_) {
      ...
      PlacementUtils.register(
         p_255657_, BAMBOO_LIGHT, holder, RarityFilter.onAverageOnceEvery(4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()
      );
      PlacementUtils.register(
         p_255657_,
         BAMBOO,
      ...
      PlacementUtils.register(
         p_255657_, PATCH_SUNFLOWER, holder3, RarityFilter.onAverageOnceEvery(3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()
      );
      PlacementUtils.register(
         p_255657_, PATCH_PUMPKIN, holder4, RarityFilter.onAverageOnceEvery(300), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()
      );
      PlacementUtils.register(
         p_255657_,
         PATCH_GRASS_PLAIN,
      ...
      PlacementUtils.register(
         p_255657_, PATCH_MELON, holder10, RarityFilter.onAverageOnceEvery(6), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()
      );
      PlacementUtils.register(
         p_255657_,
         PATCH_MELON_SPARSE,
      ...
      PlacementUtils.register(
         p_255657_, PATCH_TALL_GRASS, holder13, RarityFilter.onAverageOnceEvery(5), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()
      );
      PlacementUtils.register(
         p_255657_, PATCH_LARGE_FERN, holder14, RarityFilter.onAverageOnceEvery(5), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()
      );
      PlacementUtils.register(
         p_255657_,
         PATCH_CACTUS_DESERT,
      ...
      PlacementUtils.register(
         p_255657_, PATCH_SUGAR_CANE, holder16, RarityFilter.onAverageOnceEvery(6), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()
      );
      PlacementUtils.register(
         p_255657_,
      ...
      PlacementUtils.register(p_255657_, BROWN_MUSHROOM_NORMAL, holder17, getMushroomPlacement(256, null));
      PlacementUtils.register(p_255657_, RED_MUSHROOM_NORMAL, holder18, getMushroomPlacement(512, null));
      PlacementUtils.register(p_255657_, BROWN_MUSHROOM_TAIGA, holder17, getMushroomPlacement(4, null));
      PlacementUtils.register(p_255657_, RED_MUSHROOM_TAIGA, holder18, getMushroomPlacement(256, null));
      PlacementUtils.register(p_255657_, BROWN_MUSHROOM_OLD_GROWTH, holder17, getMushroomPlacement(4, CountPlacement.of(3)));
      PlacementUtils.register(p_255657_, RED_MUSHROOM_OLD_GROWTH, holder18, getMushroomPlacement(171, null));
      PlacementUtils.register(p_255657_, BROWN_MUSHROOM_SWAMP, holder17, getMushroomPlacement(0, CountPlacement.of(2)));
      PlacementUtils.register(p_255657_, RED_MUSHROOM_SWAMP, holder18, getMushroomPlacement(64, null));
      PlacementUtils.register(
         p_255657_, FLOWER_WARM, holder19, RarityFilter.onAverageOnceEvery(16), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()
      );
      PlacementUtils.register(
         p_255657_, FLOWER_DEFAULT, holder19, RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()
      );
      PlacementUtils.register(
         p_255657_,
      ...
      PlacementUtils.register(
         p_255657_, FLOWER_SWAMP, holder21, RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()
      );
      PlacementUtils.register(
         p_255657_,
         FLOWER_PLAINS,
