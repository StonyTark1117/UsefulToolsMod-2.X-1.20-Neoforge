...
public class ProcessorLists {
   ...
   private static void register(
      BootstapContext<StructureProcessorList> p_256641_, ResourceKey<StructureProcessorList> p_256192_, List<StructureProcessor> p_255805_
   ) {
      p_256641_.register(p_256192_, new StructureProcessorList(p_255805_));
   }

   public static void bootstrap(BootstapContext<StructureProcessorList> p_256523_) {
      HolderGetter<Block> holdergetter = p_256523_.lookup(Registries.BLOCK);
      ...
      register(p_256523_, EMPTY, ImmutableList.of());
      register(
         p_256523_,
         ZOMBIE_PLAINS,
         ImmutableList.of(
      ...
      register(p_256523_, OUTPOST_ROT, ImmutableList.of(new BlockRotProcessor(0.05F)));
      register(
         p_256523_,
         BOTTOM_RAMPART,
         ImmutableList.of(
      ...
      register(p_256523_, FOSSIL_ROT, ImmutableList.of(new BlockRotProcessor(0.9F), new ProtectedBlockProcessor(BlockTags.FEATURES_CANNOT_REPLACE)));
      register(p_256523_, FOSSIL_COAL, ImmutableList.of(new BlockRotProcessor(0.1F), new ProtectedBlockProcessor(BlockTags.FEATURES_CANNOT_REPLACE)));
      register(
         p_256523_,
         FOSSIL_DIAMONDS,
         ImmutableList.of(
      ...
      register(p_256523_, TRAIL_RUINS_TOWER_TOP_ARCHAEOLOGY, List.of(trailsArchyLootProcessor(BuiltInLootTables.TRAIL_RUINS_ARCHAEOLOGY_COMMON, 2)));
   }
