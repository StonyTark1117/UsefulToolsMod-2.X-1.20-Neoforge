...
public class TrailRuinsStructurePools {
   ...
   public static void bootstrap(BootstapContext<StructureTemplatePool> p_277535_) {
      HolderGetter<StructureTemplatePool> holdergetter = p_277535_.lookup(Registries.TEMPLATE_POOL);
      Holder<StructureTemplatePool> holder = holdergetter.getOrThrow(Pools.EMPTY);
      HolderGetter<StructureProcessorList> holdergetter1 = p_277535_.lookup(Registries.PROCESSOR_LIST);
