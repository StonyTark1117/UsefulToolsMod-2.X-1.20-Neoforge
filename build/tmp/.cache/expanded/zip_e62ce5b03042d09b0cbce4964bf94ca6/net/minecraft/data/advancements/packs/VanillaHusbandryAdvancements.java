         ...
         .forEach(
            p_300703_ -> p_249739_.addCriterion(
                  ...
                  PlayerInteractTrigger.TriggerInstance.itemUsedOnEntity(
                     ...
                     Optional.of(
                        EntityPredicate.wrap(EntityPredicate.Builder.entity().of(EntityType.FROG).subPredicate(EntitySubPredicate.variant(p_300703_.value())))
                     )
                  )
               )
         );
      ...
      BuiltInRegistries.CAT_VARIANT
         ...
         .forEach(
            p_300699_ -> p_249232_.addCriterion(
                  ...
                  TameAnimalTrigger.TriggerInstance.tamedAnimal(EntityPredicate.Builder.entity().subPredicate(EntitySubPredicate.variant(p_300699_.getValue())))
               )
         );
      return p_249232_;
   }
