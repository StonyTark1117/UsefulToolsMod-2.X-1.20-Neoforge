...
public abstract class PropertyDispatch {
   ...
   public static class C1<T1 extends Comparable<T1>> extends PropertyDispatch {
      ...
      public PropertyDispatch generate(Function<T1, Variant> p_125336_) {
         this.property1.getPossibleValues().forEach(p_125340_ -> this.select(p_125340_, p_125336_.apply(p_125340_)));
         return this;
      }

      public PropertyDispatch generateList(Function<T1, List<Variant>> p_176314_) {
         this.property1.getPossibleValues().forEach(p_176312_ -> this.select(p_176312_, p_176314_.apply(p_176312_)));
         return this;
      }
   }
         ...
         this.property1
            ...
            .forEach(
               p_125376_ -> this.property2
                     .getPossibleValues()
                     .forEach(p_176322_ -> this.select((T1)p_125376_, p_176322_, p_125363_.apply((T1)p_125376_, p_176322_)))
            );
         return this;
      }
         ...
         this.property1
            ...
            .forEach(
               p_125366_ -> this.property2
                     .getPossibleValues()
                     .forEach(p_176318_ -> this.select((T1)p_125366_, p_176318_, p_125373_.apply((T1)p_125366_, p_176318_)))
            );
         return this;
      }
   }
               ...
               p_125404_ -> this.property2
                     ...
                     .forEach(
                        p_176343_ -> this.property3
                              .getPossibleValues()
                              .forEach(
                                 p_176339_ -> this.select((T1)p_125404_, (T2)p_176343_, p_176339_, p_125390_.apply((T1)p_125404_, (T2)p_176343_, p_176339_))
                              )
                     )
            );
         return this;
               ...
               p_176334_ -> this.property2
                     ...
                     .forEach(
                        p_176331_ -> this.property3
                              .getPossibleValues()
                              .forEach(
                                 p_176327_ -> this.select((T1)p_176334_, (T2)p_176331_, p_176327_, p_176345_.apply((T1)p_176334_, (T2)p_176331_, p_176327_))
                              )
                     )
            );
         return this;
                                 ...
                                 p_176376_ -> this.property4
                                       ...
                                       .forEach(
                                          p_176371_ -> this.select(
                                                ...
                                                (T3)p_176376_,
                                                p_176371_,
                                                p_176362_.apply((T1)p_176385_, (T2)p_176380_, (T3)p_176376_, p_176371_)
                                             )
                                       )
                              )
                     )
                                 ...
                                 p_176356_ -> this.property4
                                       ...
                                       .forEach(
                                          p_176351_ -> this.select(
                                                ...
                                                (T3)p_176356_,
                                                p_176351_,
                                                p_176382_.apply((T1)p_176365_, (T2)p_176360_, (T3)p_176356_, p_176351_)
                                             )
                                       )
                              )
                     )
                                          ...
                                          p_176425_ -> this.property5
                                                ...
                                                .forEach(
                                                   p_176419_ -> this.select(
                                                         ...
                                                         (T4)p_176425_,
                                                         p_176419_,
                                                         p_176409_.apply((T1)p_176439_, (T2)p_176434_, (T3)p_176430_, (T4)p_176425_, p_176419_)
                                                      )
                                                )
                                       )
                              )
                                          ...
                                          p_176398_ -> this.property5
                                                ...
                                                .forEach(
                                                   p_176392_ -> this.select(
                                                         ...
                                                         (T4)p_176398_,
                                                         p_176392_,
                                                         p_176436_.apply((T1)p_176412_, (T2)p_176407_, (T3)p_176403_, (T4)p_176398_, p_176392_)
                                                      )
                                                )
                                       )
                              )
