...
public class BastionTreasureRoomPools {
   public static void bootstrap(BootstapContext<StructureTemplatePool> p_255689_) {
      HolderGetter<StructureProcessorList> holdergetter = p_255689_.lookup(Registries.PROCESSOR_LIST);
      ...
      HolderGetter<StructureTemplatePool> holdergetter1 = p_255689_.lookup(Registries.TEMPLATE_POOL);
