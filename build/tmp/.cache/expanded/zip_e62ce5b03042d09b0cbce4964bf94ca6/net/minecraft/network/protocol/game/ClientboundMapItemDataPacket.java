...
public class ClientboundMapItemDataPacket implements Packet<ClientGamePacketListener> {
   ...
   public ClientboundMapItemDataPacket(
      int p_178970_, byte p_178971_, boolean p_178972_, @Nullable Collection<MapDecoration> p_178973_, @Nullable MapItemSavedData.MapPatch p_178974_
   ) {
   ...
   public ClientboundMapItemDataPacket(FriendlyByteBuf p_178976_) {
      ...
      this.decorations = p_178976_.readNullable(p_237731_ -> p_237731_.readList(p_178981_ -> {
   ...
   public void write(FriendlyByteBuf p_132447_) {
      ...
      p_132447_.writeNullable(this.decorations, (p_237728_, p_237729_) -> p_237728_.writeCollection(p_237729_, (p_297948_, p_297949_) -> {
