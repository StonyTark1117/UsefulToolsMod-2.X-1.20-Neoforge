...
public interface EntityDataSerializer<T> {
   ...
   static <T extends Enum<T>> EntityDataSerializer<T> simpleEnum(Class<T> p_238091_) {
      return simple(FriendlyByteBuf::writeEnum, p_238094_ -> p_238094_.readEnum(p_238091_));
   }

   static <T> EntityDataSerializer<T> simpleId(IdMap<T> p_238082_) {
      return simple((p_238088_, p_238089_) -> p_238088_.writeId(p_238082_, (T)p_238089_), p_238085_ -> p_238085_.<T>readById(p_238082_));
   }
