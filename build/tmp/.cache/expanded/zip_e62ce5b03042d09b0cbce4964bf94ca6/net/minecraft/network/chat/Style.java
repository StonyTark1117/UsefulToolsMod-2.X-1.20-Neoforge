...
public class Style {
   ...
   public static final Codec<Style> FORMATTING_CODEC = RecordCodecBuilder.create(
      p_237256_ -> p_237256_.group(
               TextColor.CODEC.optionalFieldOf("color").forGetter(p_237281_ -> Optional.ofNullable(p_237281_.color)),
               Codec.BOOL.optionalFieldOf("bold").forGetter(p_237279_ -> Optional.ofNullable(p_237279_.bold)),
               Codec.BOOL.optionalFieldOf("italic").forGetter(p_237277_ -> Optional.ofNullable(p_237277_.italic)),
               Codec.BOOL.optionalFieldOf("underlined").forGetter(p_237275_ -> Optional.ofNullable(p_237275_.underlined)),
               Codec.BOOL.optionalFieldOf("strikethrough").forGetter(p_237273_ -> Optional.ofNullable(p_237273_.strikethrough)),
               Codec.BOOL.optionalFieldOf("obfuscated").forGetter(p_237271_ -> Optional.ofNullable(p_237271_.obfuscated)),
               Codec.STRING.optionalFieldOf("insertion").forGetter(p_237269_ -> Optional.ofNullable(p_237269_.insertion)),
               ResourceLocation.CODEC.optionalFieldOf("font").forGetter(p_237267_ -> Optional.ofNullable(p_237267_.font))
            )
   ...
   private static Style create(
      ...
      Optional<String> p_237264_,
      Optional<ResourceLocation> p_237265_
   ) {
      return new Style(
   ...
   public Style withColor(@Nullable TextColor p_131149_) {
      return new Style(
         p_131149_, this.bold, this.italic, this.underlined, this.strikethrough, this.obfuscated, this.clickEvent, this.hoverEvent, this.insertion, this.font
      );
   }
   ...
   public Style withBold(@Nullable Boolean p_131137_) {
      return new Style(
         this.color, p_131137_, this.italic, this.underlined, this.strikethrough, this.obfuscated, this.clickEvent, this.hoverEvent, this.insertion, this.font
      );
   }

   public Style withItalic(@Nullable Boolean p_131156_) {
      return new Style(
         this.color, this.bold, p_131156_, this.underlined, this.strikethrough, this.obfuscated, this.clickEvent, this.hoverEvent, this.insertion, this.font
      );
   }

   public Style withUnderlined(@Nullable Boolean p_131163_) {
      return new Style(
         this.color, this.bold, this.italic, p_131163_, this.strikethrough, this.obfuscated, this.clickEvent, this.hoverEvent, this.insertion, this.font
      );
   }

   public Style withStrikethrough(@Nullable Boolean p_178523_) {
      return new Style(
         this.color, this.bold, this.italic, this.underlined, p_178523_, this.obfuscated, this.clickEvent, this.hoverEvent, this.insertion, this.font
      );
   }

   public Style withObfuscated(@Nullable Boolean p_178525_) {
      return new Style(
         this.color, this.bold, this.italic, this.underlined, this.strikethrough, p_178525_, this.clickEvent, this.hoverEvent, this.insertion, this.font
      );
   }

   public Style withClickEvent(@Nullable ClickEvent p_131143_) {
      return new Style(
         this.color, this.bold, this.italic, this.underlined, this.strikethrough, this.obfuscated, p_131143_, this.hoverEvent, this.insertion, this.font
      );
   }

   public Style withHoverEvent(@Nullable HoverEvent p_131145_) {
      return new Style(
         this.color, this.bold, this.italic, this.underlined, this.strikethrough, this.obfuscated, this.clickEvent, p_131145_, this.insertion, this.font
      );
   }

   public Style withInsertion(@Nullable String p_131139_) {
      return new Style(
         this.color, this.bold, this.italic, this.underlined, this.strikethrough, this.obfuscated, this.clickEvent, this.hoverEvent, p_131139_, this.font
      );
   }

   public Style withFont(@Nullable ResourceLocation p_131151_) {
      return new Style(
         this.color, this.bold, this.italic, this.underlined, this.strikethrough, this.obfuscated, this.clickEvent, this.hoverEvent, this.insertion, p_131151_
      );
   }
   ...
   public static class Serializer implements JsonDeserializer<Style>, JsonSerializer<Style> {
      ...
      private static ClickEvent getClickEvent(JsonObject p_131215_) {
         if (p_131215_.has("clickEvent")) {
            ...
            String s = GsonHelper.getAsString(jsonobject, "action", null);
            ClickEvent.Action clickevent$action = s == null ? null : ClickEvent.Action.getByName(s);
            String s1 = GsonHelper.getAsString(jsonobject, "value", null);
      ...
      private static String getInsertion(JsonObject p_131217_) {
         return GsonHelper.getAsString(p_131217_, "insertion", null);
      }
