...
public class HoverEvent {
   ...
   public static HoverEvent deserialize(JsonObject p_130822_) {
      String s = GsonHelper.getAsString(p_130822_, "action", null);
      if (s == null) {
         return null;
      } else {
   ...
   public static class Action<T> {
      ...
      public Action(
         String p_130842_, boolean p_130843_, Function<JsonElement, T> p_130844_, Function<T, JsonElement> p_130845_, Function<Component, T> p_130846_
      ) {
         this.name = p_130842_;
      ...
      public boolean equals(Object p_130886_) {
         if (this == p_130886_) {
            ...
            return this.type.equals(hoverevent$entitytooltipinfo.type)
               ...
               && Objects.equals(this.name, hoverevent$entitytooltipinfo.name);
         } else {
            return false;
         }
      }
   ...
   public static class ItemStackInfo {
      ...
      public boolean equals(Object p_130911_) {
         if (this == p_130911_) {
            ...
            return this.count == hoverevent$itemstackinfo.count
               ...
               && Objects.equals(this.tag, hoverevent$itemstackinfo.tag);
         } else {
            return false;
         }
      }
      ...
      private static HoverEvent.ItemStackInfo create(JsonElement p_130907_) {
         if (p_130907_.isJsonPrimitive()) {
            return new HoverEvent.ItemStackInfo(BuiltInRegistries.ITEM.get(new ResourceLocation(p_130907_.getAsString())), 1, null);
         } else {
