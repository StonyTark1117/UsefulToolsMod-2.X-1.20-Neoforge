...
public class ServerboundSetBeaconPacket implements Packet<ServerGamePacketListener> {
   ...
   public ServerboundSetBeaconPacket(FriendlyByteBuf p_179749_) {
      this.primary = p_179749_.readOptional(p_258214_ -> p_258214_.readById(BuiltInRegistries.MOB_EFFECT));
      this.secondary = p_179749_.readOptional(p_258215_ -> p_258215_.readById(BuiltInRegistries.MOB_EFFECT));
   }

   @Override
   public void write(FriendlyByteBuf p_134486_) {
      p_134486_.writeOptional(this.primary, (p_258216_, p_258217_) -> p_258216_.writeId(BuiltInRegistries.MOB_EFFECT, p_258217_));
      p_134486_.writeOptional(this.secondary, (p_258218_, p_258219_) -> p_258218_.writeId(BuiltInRegistries.MOB_EFFECT, p_258219_));
   }
