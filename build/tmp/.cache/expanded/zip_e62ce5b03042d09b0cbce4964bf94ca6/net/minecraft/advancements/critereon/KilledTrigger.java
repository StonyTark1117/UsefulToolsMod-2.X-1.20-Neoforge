...
public class KilledTrigger extends SimpleCriterionTrigger<KilledTrigger.TriggerInstance> {
   public KilledTrigger.TriggerInstance createInstance(JsonObject p_286718_, Optional<ContextAwarePredicate> p_298211_, DeserializationContext p_286514_) {
      return new KilledTrigger.TriggerInstance(
         p_298211_, EntityPredicate.fromJson(p_286718_, "entity", p_286514_), DamageSourcePredicate.fromJson(p_286718_.get("killing_blow"))
      );
   }
   ...
   public static class TriggerInstance extends AbstractCriterionTriggerInstance {
      ...
      public TriggerInstance(Optional<ContextAwarePredicate> p_298845_, Optional<ContextAwarePredicate> p_298602_, Optional<DamageSourcePredicate> p_298849_) {
         super(p_298845_);
         this.entityPredicate = p_298602_;
         this.killingBlow = p_298849_;
      }
      ...
      public static Criterion<KilledTrigger.TriggerInstance> playerKilledEntity(EntityPredicate.Builder p_152106_, DamageSourcePredicate.Builder p_301319_) {
         return CriteriaTriggers.PLAYER_KILLED_ENTITY
            .createCriterion(new KilledTrigger.TriggerInstance(Optional.empty(), Optional.of(EntityPredicate.wrap(p_152106_)), Optional.of(p_301319_.build())));
      }
      ...
      public static Criterion<KilledTrigger.TriggerInstance> entityKilledPlayer(EntityPredicate.Builder p_301108_, DamageSourcePredicate.Builder p_298860_) {
         return CriteriaTriggers.ENTITY_KILLED_PLAYER
            .createCriterion(new KilledTrigger.TriggerInstance(Optional.empty(), Optional.of(EntityPredicate.wrap(p_301108_)), Optional.of(p_298860_.build())));
      }
      ...
      public JsonObject serializeToJson() {
         ...
         this.entityPredicate.ifPresent(p_298753_ -> jsonobject.add("entity", p_298753_.toJson()));
         this.killingBlow.ifPresent(p_298761_ -> jsonobject.add("killing_blow", p_298761_.serializeToJson()));
         return jsonobject;
      }
   }
}
