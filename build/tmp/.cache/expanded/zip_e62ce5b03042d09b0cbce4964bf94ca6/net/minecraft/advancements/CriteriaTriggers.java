...
public class CriteriaTriggers {
   ...
   public static <T extends CriterionTrigger<?>> T register(String p_300853_, T p_10596_) {
      ResourceLocation resourcelocation = new ResourceLocation(p_300853_);
   ...
   @Nullable
   public static ResourceLocation getId(CriterionTrigger<?> p_301096_) {
      return CRITERIA.inverse().get(p_301096_);
   }
