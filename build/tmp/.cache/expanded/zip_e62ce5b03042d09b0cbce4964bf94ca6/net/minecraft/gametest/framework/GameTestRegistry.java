...
public class GameTestRegistry {
   ...
   public static Collection<TestFunction> getTestFunctionsForClassName(String p_127660_) {
      return TEST_FUNCTIONS.stream().filter(p_127674_ -> isTestFunctionPartOfClass(p_127674_, p_127660_)).collect(Collectors.toList());
   }
   ...
   public static Optional<TestFunction> findTestFunction(String p_127680_) {
      return getAllTestFunctions().stream().filter(p_127663_ -> p_127663_.getTestName().equalsIgnoreCase(p_127680_)).findFirst();
   }
