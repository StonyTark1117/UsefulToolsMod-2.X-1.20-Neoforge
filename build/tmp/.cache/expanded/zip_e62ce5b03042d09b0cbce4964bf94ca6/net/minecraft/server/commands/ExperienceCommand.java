...
public class ExperienceCommand {
   ...
   static enum Type {
      POINTS("points", Player::giveExperiencePoints, (p_301699_, p_301700_) -> {
         if (p_301700_ >= p_301699_.getXpNeededForNextLevel()) {
            return false;
         } else {
            p_301699_.setExperiencePoints(p_301700_);
            return true;
         }
      }, p_301701_ -> Mth.floor(p_301701_.experienceProgress * (float)p_301701_.getXpNeededForNextLevel())),
