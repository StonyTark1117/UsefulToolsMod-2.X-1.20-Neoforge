...
public class ServerScoreboard extends Scoreboard {
   ...
   public void onScoreChanged(Score p_136206_) {
      ...
      if (this.trackedObjectives.contains(p_136206_.getObjective())) {
         this.server
            .getPlayerList()
            .broadcastAll(
               new ClientboundSetScorePacket(ServerScoreboard.Method.CHANGE, p_136206_.getObjective().getName(), p_136206_.getOwner(), p_136206_.getScore())
            );
      }
   ...
   public void onPlayerRemoved(String p_136210_) {
      ...
      this.server.getPlayerList().broadcastAll(new ClientboundSetScorePacket(ServerScoreboard.Method.REMOVE, null, p_136210_, 0));
      this.setDirty();
   }
