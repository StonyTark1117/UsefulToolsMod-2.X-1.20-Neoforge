...
public class SpreadPlayersCommand {
   ...
   private static final Dynamic4CommandExceptionType ERROR_FAILED_TO_SPREAD_TEAMS = new Dynamic4CommandExceptionType(
      (p_138745_, p_138746_, p_138747_, p_138748_) -> Component.translatable("commands.spreadplayers.failed.teams", p_138745_, p_138746_, p_138747_, p_138748_)
   );
   private static final Dynamic4CommandExceptionType ERROR_FAILED_TO_SPREAD_ENTITIES = new Dynamic4CommandExceptionType(
      (p_138723_, p_138724_, p_138725_, p_138726_) -> Component.translatable(
            "commands.spreadplayers.failed.entities", p_138723_, p_138724_, p_138725_, p_138726_
         )
   );
   private static final Dynamic2CommandExceptionType ERROR_INVALID_MAX_HEIGHT = new Dynamic2CommandExceptionType(
      (p_201854_, p_201855_) -> Component.translatable("commands.spreadplayers.failed.invalid.height", p_201854_, p_201855_)
   );
                                 ...
                                 Commands.argument("respectTeams", BoolArgumentType.bool())
                                    .then(
                                       Commands.argument("targets", EntityArgument.entities())
                                          .executes(
                                             p_288627_ -> spreadPlayers(
                                                   p_288627_.getSource(),
                                                   Vec2Argument.getVec2(p_288627_, "center"),
                                                   FloatArgumentType.getFloat(p_288627_, "spreadDistance"),
                                                   FloatArgumentType.getFloat(p_288627_, "maxRange"),
                                                   p_288627_.getSource().getLevel().getMaxBuildHeight(),
                                                   BoolArgumentType.getBool(p_288627_, "respectTeams"),
                                                   EntityArgument.getEntities(p_288627_, "targets")
                                                )
                                          )
                                    )
                              )
   ...
   static class Position {
      ...
      public int getSpawnY(BlockGetter p_138759_, int p_138760_) {
         ...
         boolean flag2;
         for(boolean flag1 = p_138759_.getBlockState(blockpos$mutableblockpos).isAir();
            blockpos$mutableblockpos.getY() > p_138759_.getMinBuildHeight();
            flag1 = flag2
         ) {
            blockpos$mutableblockpos.move(Direction.DOWN);
