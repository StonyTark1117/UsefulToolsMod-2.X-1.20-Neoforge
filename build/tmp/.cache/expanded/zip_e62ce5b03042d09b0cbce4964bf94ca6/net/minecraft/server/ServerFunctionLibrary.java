...
public class ServerFunctionLibrary implements PreparableReloadListener {
   ...
   public CompletableFuture<Void> reload(
      ...
      CompletableFuture<Map<ResourceLocation, CompletableFuture<CommandFunction>>> completablefuture1 = CompletableFuture.<Map<ResourceLocation, Resource>>supplyAsync(
      ...
      return completablefuture.thenCombine(completablefuture1, Pair::of).thenCompose(p_136057_::wait).thenAcceptAsync(p_179944_ -> {
         ...
         map.forEach((p_179941_, p_179942_) -> p_179942_.handle((p_179954_, p_179955_) -> {
               if (p_179955_ != null) {
