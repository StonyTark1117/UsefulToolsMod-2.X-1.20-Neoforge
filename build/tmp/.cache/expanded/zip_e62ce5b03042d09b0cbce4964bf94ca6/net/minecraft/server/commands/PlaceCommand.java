...
public class PlaceCommand {
   ...
   private static final DynamicCommandExceptionType ERROR_TEMPLATE_INVALID = new DynamicCommandExceptionType(
      p_214582_ -> Component.translatable("commands.place.template.invalid", p_214582_)
   );
   ...
   public static int placeStructure(CommandSourceStack p_214588_, Holder.Reference<Structure> p_251799_, BlockPos p_214590_) throws CommandSyntaxException {
      ...
      if (!structurestart.isValid()) {
         ...
         ChunkPos.rangeClosed(chunkpos, chunkpos1)
            .forEach(
               p_301716_ -> structurestart.placeInChunk(
                     serverlevel,
                     serverlevel.structureManager(),
                     chunkgenerator,
                     serverlevel.getRandom(),
                     new BoundingBox(
                        p_301716_.getMinBlockX(),
                        serverlevel.getMinBuildHeight(),
                        p_301716_.getMinBlockZ(),
                        p_301716_.getMaxBlockX(),
                        serverlevel.getMaxBuildHeight(),
                        p_301716_.getMaxBlockZ()
                     ),
                     p_301716_
                  )
            );
      ...
      if (optional.isEmpty()) {
         ...
         if (!flag) {
            ...
            p_214562_.sendSuccess(
               () -> Component.translatable("commands.place.template.success", p_214563_, p_214564_.getX(), p_214564_.getY(), p_214564_.getZ()), true
            );
            return 1;
         }
      }
   ...
   private static void checkLoaded(ServerLevel p_214544_, ChunkPos p_214545_, ChunkPos p_214546_) throws CommandSyntaxException {
      if (ChunkPos.rangeClosed(p_214545_, p_214546_).filter(p_214542_ -> !p_214544_.isLoaded(p_214542_.getWorldPosition())).findAny().isPresent()) {
