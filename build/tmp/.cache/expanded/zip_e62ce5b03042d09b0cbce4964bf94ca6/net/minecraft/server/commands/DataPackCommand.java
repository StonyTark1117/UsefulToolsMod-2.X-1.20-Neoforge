                     ...
                     Commands.argument("name", StringArgumentType.string())
                        ...
                        .executes(
                           p_136876_ -> enablePack(
                                 ...
                                 (p_180059_, p_180060_) -> p_180060_.getDefaultPosition().insert(p_180059_, p_180060_, p_180062_ -> p_180062_, false)
                              )
                        )
                        .then(
                                 ...
                                 Commands.argument("existing", StringArgumentType.string())
                                    ...
                                    .executes(
                                       p_136880_ -> enablePack(
                                             ...
                                             (p_180056_, p_180057_) -> p_180056_.add(p_180056_.indexOf(getPack(p_136880_, "existing", false)) + 1, p_180057_)
                                          )
                                    )
                              )
                        )
                                 ...
                                 Commands.argument("existing", StringArgumentType.string())
                                    ...
                                    .executes(
                                       p_136878_ -> enablePack(
                                             ...
                                             (p_180046_, p_180047_) -> p_180046_.add(p_180046_.indexOf(getPack(p_136878_, "existing", false)), p_180047_)
                                          )
                                    )
                              )
                        )
                        .then(Commands.literal("last").executes(p_136874_ -> enablePack(p_136874_.getSource(), getPack(p_136874_, "name", true), List::add)))
                        .then(
