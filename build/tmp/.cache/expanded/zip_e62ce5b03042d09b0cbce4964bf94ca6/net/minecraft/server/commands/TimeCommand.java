               ...
               Commands.literal("query")
                  ...
                  .then(
                     Commands.literal("gametime")
                        .executes(p_288691_ -> queryTime(p_288691_.getSource(), (int)(p_288691_.getSource().getLevel().getGameTime() % 2147483647L)))
                  )
                  .then(
                     Commands.literal("day")
                        .executes(p_288689_ -> queryTime(p_288689_.getSource(), (int)(p_288689_.getSource().getLevel().getDayTime() / 24000L % 2147483647L)))
                  )
            )
      );
   }
