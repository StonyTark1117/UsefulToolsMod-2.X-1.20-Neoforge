...
public class EnchantCommand {
   private static final DynamicCommandExceptionType ERROR_NOT_LIVING_ENTITY = new DynamicCommandExceptionType(
      p_137029_ -> Component.translatable("commands.enchant.failed.entity", p_137029_)
   );
   private static final DynamicCommandExceptionType ERROR_NO_ITEM = new DynamicCommandExceptionType(
      p_137027_ -> Component.translatable("commands.enchant.failed.itemless", p_137027_)
   );
   private static final DynamicCommandExceptionType ERROR_INCOMPATIBLE = new DynamicCommandExceptionType(
      p_137020_ -> Component.translatable("commands.enchant.failed.incompatible", p_137020_)
   );
   private static final Dynamic2CommandExceptionType ERROR_LEVEL_TOO_HIGH = new Dynamic2CommandExceptionType(
      (p_137022_, p_137023_) -> Component.translatable("commands.enchant.failed.level", p_137022_, p_137023_)
   );
