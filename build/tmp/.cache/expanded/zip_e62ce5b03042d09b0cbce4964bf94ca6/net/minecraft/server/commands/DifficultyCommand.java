...
public class DifficultyCommand {
   private static final DynamicCommandExceptionType ERROR_ALREADY_DIFFICULT = new DynamicCommandExceptionType(
      p_136948_ -> Component.translatable("commands.difficulty.failure", p_136948_)
   );
   ...
   public static void register(CommandDispatcher<CommandSourceStack> p_136939_) {
      ...
      p_136939_.register(literalargumentbuilder.requires(p_136943_ -> p_136943_.hasPermission(2)).executes(p_288367_ -> {
         Difficulty difficulty1 = p_288367_.getSource().getLevel().getDifficulty();
         p_288367_.getSource().sendSuccess(() -> Component.translatable("commands.difficulty.query", difficulty1.getDisplayName()), false);
