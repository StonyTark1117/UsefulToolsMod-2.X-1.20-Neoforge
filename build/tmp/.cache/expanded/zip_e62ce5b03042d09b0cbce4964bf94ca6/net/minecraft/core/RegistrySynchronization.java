...
public class RegistrySynchronization {
   ...
   private static <E> void put(
      Builder<ResourceKey<? extends Registry<?>>, RegistrySynchronization.NetworkedRegistryData<?>> p_251643_,
      ResourceKey<? extends Registry<E>> p_249195_,
      Codec<E> p_249212_
   ) {
   ...
   private static <K extends ResourceKey<? extends Registry<?>>, V extends Registry<?>> Codec<RegistryAccess> captureMap(UnboundedMapCodec<K, V> p_249934_) {
      return p_249934_.xmap(
         ...
         p_251578_ -> ownedNetworkableRegistries(p_251578_).collect(ImmutableMap.toImmutableMap(p_250395_ -> (K)p_250395_.key(), p_248951_ -> (V)p_248951_.value()))
      );
   }
