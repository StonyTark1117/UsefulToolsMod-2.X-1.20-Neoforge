   ...
   public void registerTypes(Schema p_17540_, Map<String, Supplier<TypeTemplate>> p_17541_, Map<String, Supplier<TypeTemplate>> p_17542_) {
      ...
      p_17540_.registerType(
         ...
         () -> DSL.optionalFields(
               ...
               DSL.optionalFields(
                  "minecraft:mined",
                  DSL.compoundList(References.BLOCK_NAME.in(p_17540_), DSL.constType(DSL.intType())),
                  "minecraft:crafted",
                  supplier.get(),
                  "minecraft:used",
                  supplier.get(),
                  ...
                  DSL.optionalFields(
                     ...
                     supplier.get(),
                     "minecraft:killed",
                     DSL.compoundList(References.ENTITY_NAME.in(p_17540_), DSL.constType(DSL.intType())),
                     "minecraft:killed_by",
                     DSL.compoundList(References.ENTITY_NAME.in(p_17540_), DSL.constType(DSL.intType())),
                     "minecraft:custom",
