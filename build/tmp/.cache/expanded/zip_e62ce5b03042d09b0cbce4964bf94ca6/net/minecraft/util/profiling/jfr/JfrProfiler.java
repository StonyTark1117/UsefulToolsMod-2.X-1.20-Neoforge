...
public class JfrProfiler implements JvmProfiler {
   ...
   @Override
   public void onPacketReceived(ConnectionProtocol p_294286_, int p_185302_, SocketAddress p_185304_, int p_185303_) {
      if (PacketReceivedEvent.TYPE.isEnabled()) {
         new PacketReceivedEvent(p_294286_.id(), p_185302_, p_185304_, p_185303_).commit();
      }
   ...
   @Override
   public void onPacketSent(ConnectionProtocol p_295940_, int p_185323_, SocketAddress p_185325_, int p_185324_) {
      if (PacketSentEvent.TYPE.isEnabled()) {
         new PacketSentEvent(p_295940_.id(), p_185323_, p_185325_, p_185324_).commit();
      }
