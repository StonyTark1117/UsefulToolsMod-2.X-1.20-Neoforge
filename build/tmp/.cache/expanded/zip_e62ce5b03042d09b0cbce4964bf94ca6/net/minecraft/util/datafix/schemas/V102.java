      ...
      p_17361_.registerType(
         ...
         () -> DSL.hook(
               DSL.optionalFields(
                  ...
                  DSL.optionalFields(
                     "EntityTag",
                     References.ENTITY_TREE.in(p_17361_),
                     "BlockEntityTag",
                     References.BLOCK_ENTITY.in(p_17361_),
                     "CanDestroy",
                     DSL.list(References.BLOCK_NAME.in(p_17361_)),
                     "CanPlaceOn",
                     DSL.list(References.BLOCK_NAME.in(p_17361_)),
                     "Items",
                     DSL.list(References.ITEM_STACK.in(p_17361_))
                  )
               ),
               V99.ADD_NAMES,
