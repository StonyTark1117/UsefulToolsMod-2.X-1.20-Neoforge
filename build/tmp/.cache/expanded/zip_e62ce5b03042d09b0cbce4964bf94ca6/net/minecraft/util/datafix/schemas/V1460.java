...
public class V1460 extends NamespacedSchema {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema p_17658_) {
      ...
      p_17658_.register(map, "minecraft:commandblock_minecart", p_17677_ -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(p_17658_)));
      ...
      p_17658_.register(
         ...
         p_17598_ -> DSL.optionalFields(
               ...
               DSL.optionalFields(
                  ...
                  DSL.list(
                     DSL.optionalFields(
                        "buy", References.ITEM_STACK.in(p_17658_), "buyB", References.ITEM_STACK.in(p_17658_), "sell", References.ITEM_STACK.in(p_17658_)
                     )
                  )
               ),
               V100.equipment(p_17658_)
   ...
   public void registerTypes(Schema p_17660_, Map<String, Supplier<TypeTemplate>> p_17661_, Map<String, Supplier<TypeTemplate>> p_17662_) {
      ...
      p_17660_.registerType(
         ...
         () -> DSL.optionalFields(
               "RootVehicle",
               DSL.optionalFields("Entity", References.ENTITY_TREE.in(p_17660_)),
               "Inventory",
               DSL.list(References.ITEM_STACK.in(p_17660_)),
               "EnderItems",
               DSL.list(References.ITEM_STACK.in(p_17660_)),
               DSL.optionalFields(
                  "ShoulderEntityLeft",
                  References.ENTITY_TREE.in(p_17660_),
                  "ShoulderEntityRight",
                  References.ENTITY_TREE.in(p_17660_),
                  "recipeBook",
      ...
      p_17660_.registerType(true, References.BLOCK_ENTITY, () -> DSL.taggedChoiceLazy("id", namespacedString(), p_17662_));
      p_17660_.registerType(
         ...
         () -> DSL.hook(
               DSL.optionalFields(
                  ...
                  DSL.optionalFields(
                     ...
                     References.ENTITY_TREE.in(p_17660_),
                     "BlockEntityTag",
                     References.BLOCK_ENTITY.in(p_17660_),
                     "CanDestroy",
                     DSL.list(References.BLOCK_NAME.in(p_17660_)),
                     "CanPlaceOn",
                     DSL.list(References.BLOCK_NAME.in(p_17660_)),
                     "Items",
                     DSL.list(References.ITEM_STACK.in(p_17660_))
      ...
      p_17660_.registerType(
         ...
         () -> DSL.optionalFields(
               ...
               DSL.optionalFields(
                  "minecraft:mined",
                  DSL.compoundList(References.BLOCK_NAME.in(p_17660_), DSL.constType(DSL.intType())),
                  "minecraft:crafted",
                  supplier.get(),
                  "minecraft:used",
                  supplier.get(),
                  ...
                  DSL.optionalFields(
                     ...
                     supplier.get(),
                     "minecraft:killed",
                     DSL.compoundList(References.ENTITY_NAME.in(p_17660_), DSL.constType(DSL.intType())),
                     "minecraft:killed_by",
                     DSL.compoundList(References.ENTITY_NAME.in(p_17660_), DSL.constType(DSL.intType())),
                     "minecraft:custom",
