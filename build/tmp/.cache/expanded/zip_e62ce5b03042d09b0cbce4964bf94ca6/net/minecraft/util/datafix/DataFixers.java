...
public class DataFixers {
   ...
   private static void addFixers(DataFixerBuilder p_14514_) {
      ...
      p_14514_.addFixer(
         new NamespacedTypeRenameFix(schema120, "Nether biome rename", References.BIOME, createRenamer("minecraft:nether", "minecraft:nether_wastes"))
      );
      ...
      p_14514_.addFixer(
         BlockRenameFixWithJigsaw.create(schema126, "Renamed grass path block to dirt path", createRenamer("minecraft:grass_path", "minecraft:dirt_path"))
      );
      ...
      p_14514_.addFixer(
         ItemRenameFix.create(
            schema140, "Rename azalea_leaves_flowers", createRenamer(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))
         )
      );
      p_14514_.addFixer(
         BlockRenameFix.create(
      ...
      p_14514_.addFixer(
         new NamespacedTypeRenameFix(schema145, "Caves and Cliffs biome renames", References.BIOME, createRenamer(CavesAndCliffsRenames.RENAMES))
      );
      ...
      p_14514_.addFixer(
         new NamespacedTypeRenameFix(schema148, "Remove Deep Warm Ocean", References.BIOME, createRenamer("minecraft:deep_warm_ocean", "minecraft:warm_ocean"))
      );
      ...
      p_14514_.addFixer(
         new EntityVariantFix(
            schema160, "Change cat variant type", References.ENTITY, "minecraft:cat", "CatType", Util.make(new Int2ObjectOpenHashMap<String>(), p_216528_ -> {
      ...
      p_14514_.addFixer(
         new EntityVariantFix(
            schema161, "Change frog variant type", References.ENTITY, "minecraft:frog", "Variant", Util.make(new Int2ObjectOpenHashMap<String>(), p_216519_ -> {
      ...
      p_14514_.addFixer(
         BlockEntityRenameFix.create(
            schema179, "Rename Suspicious Sand to Brushable Block", createRenamer("minecraft:suspicious_sand", "minecraft:brushable_block")
         )
      );
   ...
   private static UnaryOperator<String> createRenamer(Map<String, String> p_14525_) {
      return p_216526_ -> p_14525_.getOrDefault(p_216526_, p_216526_);
   }

   private static UnaryOperator<String> createRenamer(String p_14518_, String p_14519_) {
      return p_216523_ -> Objects.equals(p_216523_, p_14518_) ? p_14519_ : p_216523_;
   }
}
