...
public class MobEffectIdFix extends DataFix {
   ...
   private static <T> Dynamic<T> setFieldIfPresent(Dynamic<T> p_298554_, String p_298711_, Optional<Dynamic<T>> p_298798_) {
      return p_298798_.isEmpty() ? p_298554_ : p_298554_.set(p_298711_, p_298798_.get());
   }

   private static <T> Dynamic<T> replaceField(Dynamic<T> p_299198_, String p_298443_, String p_298859_, Optional<Dynamic<T>> p_299082_) {
      return setFieldIfPresent(p_299198_.remove(p_298443_), p_298859_, p_299082_);
   }

   private static <T> Dynamic<T> renameField(Dynamic<T> p_298690_, String p_299008_, String p_298543_) {
      return setFieldIfPresent(p_298690_.remove(p_299008_), p_298543_, p_298690_.get(p_299008_).result());
   }
   ...
   private static <T> Dynamic<T> updateMobEffectIdField(Dynamic<T> p_298948_, String p_299234_, Dynamic<T> p_298832_, String p_298487_) {
      ...
      return replaceField(p_298832_, p_299234_, p_298487_, optional);
   }
   ...
   private static <T> Dynamic<T> updateMobEffectInstanceList(Dynamic<T> p_299048_, String p_298254_, String p_298643_) {
      ...
      return replaceField(p_299048_, p_298254_, p_298643_, optional);
   }
