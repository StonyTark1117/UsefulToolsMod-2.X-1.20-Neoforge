   ...
   public static record PacketIdentification(PacketFlow direction, String protocolId, int packetId) {
      ...
      public static NetworkPacketSummary.PacketIdentification from(RecordedEvent p_185778_) {
         return new NetworkPacketSummary.PacketIdentification(
            p_185778_.getEventType().getName().equals("minecraft.PacketSent") ? PacketFlow.CLIENTBOUND : PacketFlow.SERVERBOUND,
            p_185778_.getString("protocolId"),
            p_185778_.getInt("packetId")
         );
      }
