   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         p_181039_ -> p_181039_.update(
               DSL.remainderFinder(),
               p_145556_ -> p_145556_.update(
                     "DisplayName",
                     p_145559_ -> DataFixUtils.orElse(
                           p_145559_.asString()
                              .map(p_145561_ -> Component.Serializer.toJson(Component.literal(p_145561_)))
                              .map(p_145556_::createString)
                              .result(),
                           p_145559_
                        )
                  )
