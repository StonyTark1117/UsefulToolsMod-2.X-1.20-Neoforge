   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         p_185179_ -> {
            ...
            return p_185179_.update(DSL.remainderFinder(), p_185205_ -> p_185205_.remove("has_increased_height_already"))
               .updateTyped(
                  opticfinder,
                  type2,
                  p_185190_ -> {
                     Dynamic<?> dynamic = p_185190_.write().result().orElseThrow(() -> new IllegalStateException("Malformed WorldGenSettings.dimensions"));
                     ...
                     return (Typed<?>)((Pair)type2.readTyped(dynamic)
                           .result()
