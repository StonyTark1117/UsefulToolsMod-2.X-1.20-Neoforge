...
public class ChunkHeightAndBiomeFix extends DataFix {
               ...
               p_184884_ -> {
                  ...
                  p_184884_ = p_184884_.updateTyped(
                     ...
                     p_184936_ -> {
                        ...
                        return (Typed<?>)((Pair)type3.readTyped(dynamic.createList(list.stream()))
                              .result()
   ...
   private static Dynamic<?>[] getBiomeContainers(Dynamic<?> p_184907_, boolean p_184908_, int p_184909_, MutableBoolean p_184910_) {
      ...
      int[] aint = (int[])p_184907_.get("Biomes").asIntStreamOpt().result().map(IntStream::toArray).orElse(null);
