      ...
      return ExtraCodecs.validate(
         ...
         p_274951_ -> {
            if (p_274951_.getMinValue() < p_273149_) {
               return DataResult.error(() -> "Value provider too low: " + p_273149_ + " [" + p_274951_.getMinValue() + "-" + p_274951_.getMaxValue() + "]");
            } else {
               return p_274951_.getMaxValue() > p_272813_
                  ? DataResult.error(() -> "Value provider too high: " + p_272813_ + " [" + p_274951_.getMinValue() + "-" + p_274951_.getMaxValue() + "]")
