...
public class V705 extends NamespacedSchema {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema p_18148_) {
      ...
      p_18148_.register(map, "minecraft:commandblock_minecart", p_18158_ -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in(p_18148_)));
      ...
      p_18148_.register(
         ...
         p_18101_ -> DSL.optionalFields(
               ...
               DSL.optionalFields(
                  ...
                  DSL.list(
                     DSL.optionalFields(
                        "buy", References.ITEM_STACK.in(p_18148_), "buyB", References.ITEM_STACK.in(p_18148_), "sell", References.ITEM_STACK.in(p_18148_)
                     )
                  )
               ),
      ...
      p_18150_.registerType(
         ...
         () -> DSL.hook(
               DSL.optionalFields(
                  ...
                  DSL.optionalFields(
                     "EntityTag",
                     References.ENTITY_TREE.in(p_18150_),
                     "BlockEntityTag",
                     References.BLOCK_ENTITY.in(p_18150_),
                     "CanDestroy",
                     DSL.list(References.BLOCK_NAME.in(p_18150_)),
                     "CanPlaceOn",
                     DSL.list(References.BLOCK_NAME.in(p_18150_)),
                     "Items",
                     DSL.list(References.ITEM_STACK.in(p_18150_))
                  )
               ),
               ADD_NAMES,
