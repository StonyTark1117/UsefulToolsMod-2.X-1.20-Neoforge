...
public class FontManager implements PreparableReloadListener, AutoCloseable {
   ...
   public FontManager(TextureManager p_95005_) {
      ...
      this.missingFontSet = Util.make(new FontSet(p_95005_, MISSING_FONT), p_95010_ -> p_95010_.reload(Lists.newArrayList(new AllMissingGlyphProvider())));
   }
                  ...
                  .thenCompose(
                     p_284618_ -> {
                        ...
                        CompletableFuture<?>[] completablefuture = map.values()
                           .stream()
                           .map(p_284585_ -> CompletableFuture.runAsync(() -> this.finalizeProviderLoading(p_284585_, glyphprovider), p_284969_))
