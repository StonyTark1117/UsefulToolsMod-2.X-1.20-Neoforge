...
public class BeeStingerLayer<T extends LivingEntity, M extends PlayerModel<T>> extends StuckInBodyLayer<T, M> {
   ...
   private static void vertex(
      VertexConsumer p_254470_, Matrix4f p_254513_, Matrix3f p_254052_, float p_253749_, int p_254520_, float p_254099_, float p_253914_, int p_254168_
   ) {
      p_254470_.vertex(p_254513_, p_253749_, (float)p_254520_, 0.0F)
         .color(255, 255, 255, 255)
         .uv(p_254099_, p_253914_)
         .overlayCoords(OverlayTexture.NO_OVERLAY)
         .uv2(p_254168_)
         .normal(p_254052_, 0.0F, 1.0F, 0.0F)
         .endVertex();
   }
}
