...
public class BeeDebugRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   private void renderFlowerInfos(PoseStack p_270578_, MultiBufferSource p_270098_) {
      ...
      map.forEach((p_293631_, p_293632_) -> {
         ...
         int i = 1;
         renderTextOverPos(p_270578_, p_270098_, set.toString(), p_293631_, i++, -256);
         renderTextOverPos(p_270578_, p_270098_, "Flower", p_293631_, i++, -1);
         float f = 0.05F;
         DebugRenderer.renderFilledBox(p_270578_, p_270098_, p_293631_, 0.05F, 0.8F, 0.8F, 0.0F, 0.3F);
      });
   }
