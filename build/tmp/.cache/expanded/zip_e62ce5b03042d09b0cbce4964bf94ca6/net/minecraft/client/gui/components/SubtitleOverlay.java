   ...
   public void render(GuiGraphics p_282562_) {
      ...
      if (this.isListening && !this.subtitles.isEmpty()) {
         ...
         while(iterator.hasNext()) {
            ...
            if ((double)subtitleoverlay$subtitle.getTime() + 3000.0 * d0 <= (double)Util.getMillis()) {
               iterator.remove();
            } else {
         ...
         for(SubtitleOverlay.Subtitle subtitleoverlay$subtitle1 : this.subtitles) {
            ...
            int l1 = Mth.floor(Mth.clampedLerp(255.0F, 75.0F, (float)(Util.getMillis() - subtitleoverlay$subtitle1.getTime()) / (float)(3000.0 * d0)));
            int i2 = l1 << 16 | l1 << 8 | l1;
            p_282562_.pose().pushPose();
            p_282562_.pose()
               .translate((float)p_282562_.guiWidth() - (float)l * 1.0F - 2.0F, (float)(p_282562_.guiHeight() - 35) - (float)(i * (i1 + 1)) * 1.0F, 0.0F);
