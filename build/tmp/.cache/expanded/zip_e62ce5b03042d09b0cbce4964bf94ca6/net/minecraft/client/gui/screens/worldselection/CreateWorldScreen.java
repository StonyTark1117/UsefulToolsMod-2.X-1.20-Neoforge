...
public class CreateWorldScreen extends Screen {
   ...
   public static CreateWorldScreen createFromExisting(
      ...
      CreateWorldScreen createworldscreen = new CreateWorldScreen(
         p_276017_, p_276029_, p_276028_, WorldPresets.fromSettings(p_276028_.selectedDimensions().dimensions()), OptionalLong.of(p_276028_.options().seed())
      );
      ...
      WorldLoader.<CreateWorldScreen.DataPackReloadCookie, WorldCreationContext>load(
            ...
            p_247793_ -> {
               if (p_247793_.datapackWorldgen().registryOrThrow(Registries.WORLD_PRESET).size() == 0) {
                  ...
                  WorldGenSettings worldgensettings = dataresult.<WorldGenSettings>flatMap(p_232895_ -> WorldGenSettings.CODEC.parse(dynamicops1, p_232895_))
