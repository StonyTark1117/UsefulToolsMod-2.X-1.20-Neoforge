   ...
   protected void init() {
      ...
      this.jointButton = this.addRenderableWidget(
         CycleButton.builder(JigsawBlockEntity.JointType::getTranslatedName)
            ...
            .displayOnlyValue()
            .create(this.width / 2 - 152 + i, 150, 300 - i, 20, JOINT_LABEL, (p_169765_, p_169766_) -> this.joint = p_169766_)
      );
      ...
      this.addRenderableWidget(
         CycleButton.onOffBuilder(this.keepJigsaws)
            .create(
               this.width / 2 - 50, 180, 100, 20, Component.translatable("jigsaw_block.keep_jigsaws"), (p_169768_, p_169769_) -> this.keepJigsaws = p_169769_
            )
      );
