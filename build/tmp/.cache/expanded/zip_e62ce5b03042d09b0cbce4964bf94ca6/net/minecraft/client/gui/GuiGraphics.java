...
public class GuiGraphics implements net.neoforged.neoforge.client.extensions.IGuiGraphicsExtension {
   ...
   public int drawString(Font p_282636_, FormattedCharSequence p_281596_, float p_281586_, float p_282816_, int p_281743_, boolean p_282394_) {
      int i = p_282636_.drawInBatch(
         p_281596_, (float)p_281586_, (float)p_282816_, p_281743_, p_282394_, this.pose.last().pose(), this.bufferSource, Font.DisplayMode.NORMAL, 0, 15728880
      );
      this.flushIfUnmanaged();
      return i;
   }
   ...
   private void blitNineSlicedSprite(
      ...
      if (p_295807_ == p_295735_.width() && p_295009_ == p_295735_.height()) {
         ...
         this.blitTiledSprite(
            p_294394_, p_294769_, p_294546_ + k, p_294421_, i, p_295009_ - l - k, 0, k, i, p_295735_.height() - l - k, p_295735_.width(), p_295735_.height()
         );
         this.blitTiledSprite(
            p_294394_,
            p_294769_ + i,
   ...
   public void renderFakeItem(ItemStack p_281946_, int p_283299_, int p_283674_) {
      this.renderItem(null, this.minecraft.level, p_281946_, p_283299_, p_283674_, 0);
   }
   ...
   private void renderItem(
      ...
      if (!p_281675_.isEmpty()) {
         ...
         try {
            ...
            crashreportcategory.setDetail("Item Type / Registry Name", () -> String.valueOf(p_281675_.getItem()));
            crashreportcategory.setDetail("Item Damage", () -> String.valueOf(p_281675_.getDamageValue()));
            crashreportcategory.setDetail("Item NBT", () -> String.valueOf(p_281675_.getTag()));
