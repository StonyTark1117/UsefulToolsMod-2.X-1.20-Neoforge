...
public class ItemProperties {
   ...
   static {
      ...
      ClampedItemPropertyFunction clampeditempropertyfunction = (p_301668_, p_301669_, p_301670_, p_301671_) -> {
         if (!p_301668_.is(ItemTags.TRIMMABLE_ARMOR)) {
            return Float.NEGATIVE_INFINITY;
         } else {
            return p_301669_ == null
               ? 0.0F
               : ArmorTrim.getTrim(p_301669_.registryAccess(), p_301668_, true)
