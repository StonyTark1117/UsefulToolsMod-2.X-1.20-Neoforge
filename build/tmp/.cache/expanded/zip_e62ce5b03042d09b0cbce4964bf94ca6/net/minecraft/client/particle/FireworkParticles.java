...
public class FireworkParticles {
   ...
   public static class Starter extends NoRenderParticle {
      ...
      public Starter(
         ...
         @Nullable CompoundTag p_106765_
      ) {
      ...
      public void createParticleShape(
         double p_106786_, double[][] p_106787_, int[] p_106788_, int[] p_106789_, boolean p_106790_, boolean p_106791_, boolean p_106792_
      ) {
         double d0 = p_106787_[0][0];
         double d1 = p_106787_[0][1];
         this.createParticle(this.x, this.y, this.z, d0 * p_106786_, d1 * p_106786_, 0.0, p_106788_, p_106789_, p_106790_, p_106791_);
