...
public class ItemRenderer implements ResourceManagerReloadListener {
   ...
   public static VertexConsumer getCompassFoilBuffer(MultiBufferSource p_115181_, RenderType p_115182_, PoseStack.Pose p_115183_) {
      return VertexMultiConsumer.create(
         new SheetedDecalTextureGenerator(p_115181_.getBuffer(RenderType.glint()), p_115183_.pose(), p_115183_.normal(), 0.0078125F),
         p_115181_.getBuffer(p_115182_)
      );
   }
   ...
   public static VertexConsumer getCompassFoilBufferDirect(MultiBufferSource p_115208_, RenderType p_115209_, PoseStack.Pose p_115210_) {
      return VertexMultiConsumer.create(
         new SheetedDecalTextureGenerator(p_115208_.getBuffer(RenderType.glintDirect()), p_115210_.pose(), p_115210_.normal(), 0.0078125F),
         p_115208_.getBuffer(p_115209_)
      );
   }
