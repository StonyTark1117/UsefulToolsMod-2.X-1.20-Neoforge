...
public class Warden extends Monster implements VibrationSystem {
   ...
   public SpawnGroupData finalizeSpawn(
      ServerLevelAccessor p_219400_, DifficultyInstance p_219401_, MobSpawnType p_219402_, @Nullable SpawnGroupData p_219403_, @Nullable CompoundTag p_219404_
   ) {
   ...
   @Override
   protected Vector3f getPassengerAttachmentPoint(Entity p_294446_, EntityDimensions p_295063_, float p_295550_) {
      return new Vector3f(0.0F, p_295063_.height + 0.25F * p_295550_, 0.0F);
   }
