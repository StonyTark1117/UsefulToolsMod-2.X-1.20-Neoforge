...
public class Llama extends AbstractChestedHorse implements VariantHolder<Llama.Variant>, RangedAttackMob {
   ...
   public SpawnGroupData finalizeSpawn(
      ServerLevelAccessor p_30774_, DifficultyInstance p_30775_, MobSpawnType p_30776_, @Nullable SpawnGroupData p_30777_, @Nullable CompoundTag p_30778_
   ) {
   ...
   @Override
   protected Vector3f getPassengerAttachmentPoint(Entity p_294968_, EntityDimensions p_296042_, float p_295134_) {
      return new Vector3f(0.0F, p_296042_.height - (this.isBaby() ? 0.8125F : 0.5F) * p_295134_, -0.3F * p_295134_);
   }

   static class LlamaAttackWolfGoal extends NearestAttackableTargetGoal<Wolf> {
      public LlamaAttackWolfGoal(Llama p_30843_) {
         super(p_30843_, Wolf.class, 16, false, true, p_301883_ -> !((Wolf)p_301883_).isTame());
      }
