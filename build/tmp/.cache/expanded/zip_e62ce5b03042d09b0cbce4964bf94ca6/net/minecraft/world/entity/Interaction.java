...
public class Interaction extends Entity implements Attackable, Targeting {
   ...
   protected void addAdditionalSaveData(CompoundTag p_273772_) {
      ...
      if (this.attack != null) {
         Interaction.PlayerAction.CODEC.encodeStart(NbtOps.INSTANCE, this.attack).result().ifPresent(p_272806_ -> p_273772_.put("attack", p_272806_));
      }

      if (this.interaction != null) {
         Interaction.PlayerAction.CODEC.encodeStart(NbtOps.INSTANCE, this.interaction).result().ifPresent(p_272925_ -> p_273772_.put("interaction", p_272925_));
      }
