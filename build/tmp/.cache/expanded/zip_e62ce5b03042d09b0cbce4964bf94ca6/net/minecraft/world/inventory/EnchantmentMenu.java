   ...
   public boolean clickMenuButton(Player p_39465_, int p_39466_) {
      if (p_39466_ >= 0 && p_39466_ < this.costs.length) {
         ...
         if ((itemstack1.isEmpty() || itemstack1.getCount() < i) && !p_39465_.getAbilities().instabuild) {
            ...
            this.access.execute((p_297979_, p_297980_) -> {
               ...
               if (!list.isEmpty()) {
                  ...
                  p_297979_.playSound(null, p_297980_, SoundEvents.ENCHANTMENT_TABLE_USE, SoundSource.BLOCKS, 1.0F, p_297979_.random.nextFloat() * 0.1F + 0.9F);
               }
            });
            return true;
         }
