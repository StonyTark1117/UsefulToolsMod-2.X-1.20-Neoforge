...
public class VillagerMakeLove extends Behavior<Villager> {
   ...
   private boolean isBreedingPossible(Villager p_24640_) {
      ...
      Optional<AgeableMob> optional = brain.getMemory(MemoryModuleType.BREED_TARGET).filter(p_302185_ -> p_302185_.getType() == EntityType.VILLAGER);
      if (optional.isEmpty()) {
         return false;
      } else {
   ...
   private Optional<BlockPos> takeVacantBed(ServerLevel p_24649_, Villager p_24650_) {
      return p_24649_.getPoiManager()
         .take(p_217509_ -> p_217509_.is(PoiTypes.HOME), (p_217506_, p_217507_) -> this.canReach(p_24650_, p_217507_, p_217506_), p_24650_.blockPosition(), 48);
   }
