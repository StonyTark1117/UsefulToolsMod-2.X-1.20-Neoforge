...
public class BoatItem extends Item {
   ...
   private Boat getBoat(Level p_220017_, HitResult p_220018_) {
      return (Boat)(this.hasChest
         ? new ChestBoat(p_220017_, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z)
         : new Boat(p_220017_, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z));
   }
}
