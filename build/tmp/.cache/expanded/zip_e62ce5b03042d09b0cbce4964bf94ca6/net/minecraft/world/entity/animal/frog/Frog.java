...
public class Frog extends Animal implements VariantHolder<FrogVariant> {
   ...
   public SpawnGroupData finalizeSpawn(
      ServerLevelAccessor p_218488_, DifficultyInstance p_218489_, MobSpawnType p_218490_, @Nullable SpawnGroupData p_218491_, @Nullable CompoundTag p_218492_
   ) {
   ...
   @Override
   protected Vector3f getPassengerAttachmentPoint(Entity p_294984_, EntityDimensions p_295732_, float p_295893_) {
      return new Vector3f(0.0F, p_295732_.height - 0.125F * p_295893_, -0.25F * p_295893_);
   }
