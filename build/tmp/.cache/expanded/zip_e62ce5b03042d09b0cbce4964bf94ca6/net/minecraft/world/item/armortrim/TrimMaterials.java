...
public class TrimMaterials {
   ...
   public static Optional<Holder.Reference<TrimMaterial>> getFromIngredient(RegistryAccess p_266981_, ItemStack p_267327_) {
      return p_266981_.registryOrThrow(Registries.TRIM_MATERIAL).holders().filter(p_266876_ -> p_267327_.is(p_266876_.value().ingredient())).findFirst();
   }
   ...
   private static void register(
      ...
      Style p_268232_,
      float p_268197_,
      Map<ArmorMaterials, String> p_268352_
   ) {
