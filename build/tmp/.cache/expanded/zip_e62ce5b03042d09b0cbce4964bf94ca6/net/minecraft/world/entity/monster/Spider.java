...
public class Spider extends Monster {
   ...
   @Override
   protected Vector3f getPassengerAttachmentPoint(Entity p_295972_, EntityDimensions p_295105_, float p_295327_) {
      return new Vector3f(0.0F, p_295105_.height * 0.85F, 0.0F);
   }
   ...
   public SpawnGroupData finalizeSpawn(
      ServerLevelAccessor p_33790_, DifficultyInstance p_33791_, MobSpawnType p_33792_, @Nullable SpawnGroupData p_33793_, @Nullable CompoundTag p_33794_
   ) {
   ...
   @Override
   protected float ridingOffset(Entity p_294870_) {
      return p_294870_.getBbWidth() <= this.getBbWidth() ? -0.3125F : 0.0F;
   }
