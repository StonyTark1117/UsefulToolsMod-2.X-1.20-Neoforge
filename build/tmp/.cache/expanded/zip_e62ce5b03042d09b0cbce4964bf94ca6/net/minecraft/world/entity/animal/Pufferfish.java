...
public class Pufferfish extends AbstractFish {
   ...
   int inflateCounter;
   int deflateTimer;
   private static final Predicate<LivingEntity> SCARY_MOB = p_302196_ -> {
      if (p_302196_ instanceof Player && ((Player)p_302196_).isCreative()) {
         return false;
      } else {
         return p_302196_.getType() == EntityType.AXOLOTL || p_302196_.getMobType() != MobType.WATER;
      }
   };
