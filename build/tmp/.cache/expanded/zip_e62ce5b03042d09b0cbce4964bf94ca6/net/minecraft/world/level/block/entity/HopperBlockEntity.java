...
public class HopperBlockEntity extends RandomizableContainerBlockEntity implements Hopper {
   ...
   public static List<ItemEntity> getItemsAtAndAbove(Level p_155590_, Hopper p_155591_) {
      return p_155591_.getSuckShape()
         .toAabbs()
         .stream()
         .flatMap(
            p_155558_ -> p_155590_.getEntitiesOfClass(
                     ItemEntity.class,
                     p_155558_.move(p_155591_.getLevelX() - 0.5, p_155591_.getLevelY() - 0.5, p_155591_.getLevelZ() - 0.5),
   ...
   public static Container getContainerAt(Level p_59391_, BlockPos p_59392_) {
      return getContainerAt(p_59391_, (double)p_59392_.getX() + 0.5, (double)p_59392_.getY() + 0.5, (double)p_59392_.getZ() + 0.5);
   }
   ...
   private static Container getContainerAt(Level p_59348_, double p_59349_, double p_59350_, double p_59351_) {
      ...
      if (container == null) {
         List<Entity> list = p_59348_.getEntities(
            (Entity)null,
            new AABB(p_59349_ - 0.5, p_59350_ - 0.5, p_59351_ - 0.5, p_59349_ + 0.5, p_59350_ + 0.5, p_59351_ + 0.5),
   ...
   public static void entityInside(Level p_155568_, BlockPos p_155569_, BlockState p_155570_, Entity p_155571_, HopperBlockEntity p_155572_) {
      if (p_155571_ instanceof ItemEntity itementity
         ...
         && Shapes.joinIsNotEmpty(
            Shapes.create(p_155571_.getBoundingBox().move((double)(-p_155569_.getX()), (double)(-p_155569_.getY()), (double)(-p_155569_.getZ()))),
            p_155572_.getSuckShape(),
            BooleanOp.AND
         )) {
   ...
   protected net.neoforged.neoforge.items.IItemHandler createUnSidedHandler() {
      return new net.neoforged.neoforge.items.VanillaHopperItemHandler(this);
   }
