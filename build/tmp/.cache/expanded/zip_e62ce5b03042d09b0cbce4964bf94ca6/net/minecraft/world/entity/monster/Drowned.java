...
public class Drowned extends Zombie implements RangedAttackMob {
   ...
   public SpawnGroupData finalizeSpawn(
      ServerLevelAccessor p_32372_, DifficultyInstance p_32373_, MobSpawnType p_32374_, @Nullable SpawnGroupData p_32375_, @Nullable CompoundTag p_32376_
   ) {
   ...
   public static boolean checkDrownedSpawnRules(
      ...
      if (!p_218957_.getFluidState(p_218959_.below()).is(FluidTags.WATER)) {
         ...
         boolean flag = p_218957_.getDifficulty() != Difficulty.PEACEFUL
            && isDarkEnoughToSpawn(p_218957_, p_218959_, p_218960_)
            && (p_218958_ == MobSpawnType.SPAWNER || p_218957_.getFluidState(p_218959_).is(FluidTags.WATER));
