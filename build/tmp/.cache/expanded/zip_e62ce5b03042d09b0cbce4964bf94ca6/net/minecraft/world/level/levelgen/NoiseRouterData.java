...
public class NoiseRouterData {
   ...
   public static Holder<? extends DensityFunction> bootstrap(BootstapContext<DensityFunction> p_256220_) {
      ...
      DensityFunction densityfunction = registerAndWrap(
         p_256220_, SHIFT_X, DensityFunctions.flatCache(DensityFunctions.cache2d(DensityFunctions.shiftA(holdergetter.getOrThrow(Noises.SHIFT))))
      );
      DensityFunction densityfunction1 = registerAndWrap(
         p_256220_, SHIFT_Z, DensityFunctions.flatCache(DensityFunctions.cache2d(DensityFunctions.shiftB(holdergetter.getOrThrow(Noises.SHIFT))))
      );
      ...
      Holder<DensityFunction> holder = p_256220_.register(
         CONTINENTS,
      ...
      Holder<DensityFunction> holder1 = p_256220_.register(
      ...
      Holder<DensityFunction> holder2 = p_256220_.register(
         CONTINENTS_LARGE,
      ...
      Holder<DensityFunction> holder3 = p_256220_.register(
         EROSION_LARGE,
      ...
      registerTerrainNoises(
         p_256220_, holdergetter1, densityfunction3, holder2, holder3, OFFSET_LARGE, FACTOR_LARGE, JAGGEDNESS_LARGE, DEPTH_LARGE, SLOPED_CHEESE_LARGE, false
      );
      registerTerrainNoises(
         p_256220_,
         holdergetter1,
   ...
   private static void registerTerrainNoises(
      ...
      DensityFunction densityfunction2 = registerAndWrap(
         p_256336_, p_224482_, DensityFunctions.add(DensityFunctions.yClampedGradient(-64, 320, 1.5, -1.5), densityfunction)
      );
