...
public class Panda extends Animal {
   ...
   static final Predicate<ItemEntity> PANDA_ITEMS = p_302195_ -> {
      ItemStack itemstack = p_302195_.getItem();
      return (itemstack.is(Blocks.BAMBOO.asItem()) || itemstack.is(Blocks.CAKE.asItem())) && p_302195_.isAlive() && !p_302195_.hasPickUpDelay();
   };
   ...
   public SpawnGroupData finalizeSpawn(
      ServerLevelAccessor p_29109_, DifficultyInstance p_29110_, MobSpawnType p_29111_, @Nullable SpawnGroupData p_29112_, @Nullable CompoundTag p_29113_
   ) {
   ...
   @Override
   protected Vector3f getPassengerAttachmentPoint(Entity p_294402_, EntityDimensions p_294273_, float p_294300_) {
      return new Vector3f(0.0F, p_294273_.height - (this.isBaby() ? 0.4375F : 0.0F) * p_294300_, 0.0F);
   }
