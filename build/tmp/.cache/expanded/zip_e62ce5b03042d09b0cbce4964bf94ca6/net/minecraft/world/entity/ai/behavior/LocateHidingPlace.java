   ...
   public static OneShot<LivingEntity> create(int p_259202_, float p_259881_, int p_259982_) {
      return BehaviorBuilder.create(
         p_258505_ -> p_258505_.group(
               ...
               .apply(
                  p_258505_,
                  (p_258484_, p_258485_, p_258486_, p_258487_, p_258488_, p_258489_, p_258490_) -> (p_301792_, p_301793_, p_301794_) -> {
                        p_301792_.getPoiManager()
                           .find(p_217258_ -> p_217258_.is(PoiTypes.HOME), p_23425_ -> true, p_301793_.blockPosition(), p_259982_ + 1, PoiManager.Occupancy.ANY)
                           .filter(p_301769_ -> p_301769_.closerToCenterThan(p_301793_.position(), (double)p_259982_))
                           .or(
                              () -> p_301792_.getPoiManager()
                                    .getRandom(
                           ...
                           .ifPresent(p_301780_ -> {
                              ...
                              p_258489_.erase();
                              p_258490_.erase();
                              p_258486_.set(GlobalPos.of(p_301792_.dimension(), p_301780_));
                              if (!p_301780_.closerToCenterThan(p_301793_.position(), (double)p_259982_)) {
                                 p_258484_.set(new WalkTarget(p_301780_, p_259881_, p_259982_));
                              }
                           });
                        return true;
                     }
