...
public class InstrumentItem extends Item {
   ...
   public static void setRandom(ItemStack p_220111_, TagKey<Instrument> p_220112_, RandomSource p_220113_) {
      Optional<Holder<Instrument>> optional = BuiltInRegistries.INSTRUMENT.getTag(p_220112_).flatMap(p_220103_ -> p_220103_.getRandomElement(p_220113_));
      optional.ifPresent(p_248417_ -> setSoundVariantId(p_220111_, p_248417_));
   }
   ...
   private static void setSoundVariantId(ItemStack p_220120_, Holder<Instrument> p_220121_) {
      ...
      compoundtag.putString("instrument", p_220121_.unwrapKey().orElseThrow(() -> new IllegalStateException("Invalid instrument")).location().toString());
   }
