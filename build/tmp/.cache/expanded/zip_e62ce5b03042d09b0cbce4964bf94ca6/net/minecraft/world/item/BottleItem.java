...
public class BottleItem extends Item {
   ...
   public InteractionResultHolder<ItemStack> use(Level p_40656_, Player p_40657_, InteractionHand p_40658_) {
      List<AreaEffectCloud> list = p_40656_.getEntitiesOfClass(
         ...
         p_302221_ -> p_302221_ != null && p_302221_.isAlive() && p_302221_.getOwner() instanceof EnderDragon
      );
            ...
            if (blockhitresult.getType() == HitResult.Type.BLOCK) {
               ...
               if (p_40656_.getFluidState(blockpos).is(FluidTags.WATER)) {
                  ...
                  return InteractionResultHolder.sidedSuccess(
                     this.turnBottleIntoItem(itemstack, p_40657_, PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.WATER)), p_40656_.isClientSide()
                  );
               }
            }
