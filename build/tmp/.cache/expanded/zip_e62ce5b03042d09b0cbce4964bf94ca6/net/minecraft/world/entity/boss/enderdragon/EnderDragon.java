...
public class EnderDragon extends Mob implements Enemy {
   ...
   public void aiStep() {
      ...
      if (this.isDeadOrDying()) {
         ...
         this.level().addParticle(ParticleTypes.EXPLOSION, this.getX() + (double)f8, this.getY() + 2.0 + (double)f10, this.getZ() + (double)f11, 0.0, 0.0, 0.0);
      } else {
         this.checkCrystals();
   ...
   @Override
   protected Vector3f getPassengerAttachmentPoint(Entity p_296341_, EntityDimensions p_294538_, float p_296350_) {
