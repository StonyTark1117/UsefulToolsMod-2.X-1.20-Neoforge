...
public class WitherSkeleton extends AbstractSkeleton {
   ...
   public SpawnGroupData finalizeSpawn(
      ServerLevelAccessor p_34178_, DifficultyInstance p_34179_, MobSpawnType p_34180_, @Nullable SpawnGroupData p_34181_, @Nullable CompoundTag p_34182_
   ) {
   ...
   @Override
   protected float ridingOffset(Entity p_295859_) {
      return -0.875F;
   }
