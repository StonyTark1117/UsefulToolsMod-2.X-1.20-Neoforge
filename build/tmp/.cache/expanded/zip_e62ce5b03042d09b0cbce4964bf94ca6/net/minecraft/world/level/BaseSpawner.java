...
public abstract class BaseSpawner {
            ...
            for(int i = 0; i < this.spawnCount; ++i) {
               ...
               if (p_151312_.noCollision(optional.get().getAABB(d0, d1, d2))) {
                  ...
                  if (spawndata.getCustomSpawnRules().isPresent()) {
                     ...
                     if (!spawndata$customspawnrules.blockLightLimit().isValueInRange(p_151312_.getBrightness(LightLayer.BLOCK, blockpos))
                        || !spawndata$customspawnrules.skyLightLimit().isValueInRange(p_151312_.getBrightness(LightLayer.SKY, blockpos))) {
                        continue;
                     }
                  ...
                  int k = p_151312_.getEntitiesOfClass(
                        entity.getClass(),
                        new AABB(
   ...
   private void delay(Level p_151351_, BlockPos p_151352_) {
      ...
      this.spawnPotentials.getRandom(randomsource).ifPresent(p_186386_ -> this.setNextSpawnData(p_151351_, p_151352_, p_186386_.getData()));
