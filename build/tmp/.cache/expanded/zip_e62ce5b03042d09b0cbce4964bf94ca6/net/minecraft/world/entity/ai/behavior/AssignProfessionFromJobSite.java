...
public class AssignProfessionFromJobSite {
   public static BehaviorControl<Villager> create() {
      return BehaviorBuilder.create(
         p_258312_ -> p_258312_.group(
                  p_258312_.present(MemoryModuleType.POTENTIAL_JOB_SITE), p_258312_.registered(MemoryModuleType.JOB_SITE)
               )
               .apply(
                  p_258312_,
                              ...
                              Optional.ofNullable(minecraftserver.getLevel(globalpos.dimension()))
                                 ...
                                 .flatMap(
                                    p_258313_ -> BuiltInRegistries.VILLAGER_PROFESSION
                                          .stream()
                                          .filter(p_217125_ -> p_217125_.heldJobSite().test(p_258313_))
                                          .findFirst()
                                 )
                                 .ifPresent(p_22464_ -> {
