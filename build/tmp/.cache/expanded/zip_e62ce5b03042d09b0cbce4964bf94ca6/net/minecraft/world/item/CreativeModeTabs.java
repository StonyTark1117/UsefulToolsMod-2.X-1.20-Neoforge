...
public class CreativeModeTabs {
            ...
            .displayItems(
               (p_271005_, p_259465_) -> {
                  ...
                  p_271005_.holders()
                     ...
                     .ifPresent(
                        p_270032_ -> generatePotionEffectTypes(p_259465_, p_270032_, Items.TIPPED_ARROW, CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS)
                     );
               }
            )
            .build()
   ...
   private static void generatePotionEffectTypes(
      ...
      p_270334_.listElements()
         ...
         .map(p_269986_ -> PotionUtils.setPotion(new ItemStack(p_270968_), p_269986_.value()))
   ...
   private static void generateEnchantmentBookTypesAllLevels(
      CreativeModeTab.Output p_270961_, HolderLookup<Enchantment> p_270628_, Set<EnchantmentCategory> p_271024_, CreativeModeTab.TabVisibility p_270805_
   ) {
