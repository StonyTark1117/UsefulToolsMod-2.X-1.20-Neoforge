...
public class Vex extends Monster implements TraceableEntity {
   ...
   public SpawnGroupData finalizeSpawn(
      ServerLevelAccessor p_34002_, DifficultyInstance p_34003_, MobSpawnType p_34004_, @Nullable SpawnGroupData p_34005_, @Nullable CompoundTag p_34006_
   ) {
   ...
   @Override
   protected float ridingOffset(Entity p_295185_) {
      return 0.04F;
   }

   @Override
   protected Vector3f getPassengerAttachmentPoint(Entity p_295802_, EntityDimensions p_296173_, float p_295745_) {
      return new Vector3f(0.0F, p_296173_.height - 0.0625F * p_295745_, 0.0F);
   }
      ...
      public void tick() {
         ...
         for(int i = 0; i < 3; ++i) {
            ...
            if (Vex.this.level().isEmptyBlock(blockpos1)) {
               Vex.this.moveControl.setWantedPosition((double)blockpos1.getX() + 0.5, (double)blockpos1.getY() + 0.5, (double)blockpos1.getZ() + 0.5, 0.25);
               if (Vex.this.getTarget() == null) {
