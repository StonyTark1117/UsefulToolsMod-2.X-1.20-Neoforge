      ...
      this.goalSelector
         .addGoal(
            ...
            new UseItemGoal<>(
               ...
               p_302215_ -> this.level().isNight() && !p_302215_.isInvisible()
            )
         );
      this.goalSelector
         .addGoal(
            0,
            new UseItemGoal<>(
               this, new ItemStack(Items.MILK_BUCKET), SoundEvents.WANDERING_TRADER_REAPPEARED, p_302214_ -> this.level().isDay() && p_302214_.isInvisible()
            )
         );
