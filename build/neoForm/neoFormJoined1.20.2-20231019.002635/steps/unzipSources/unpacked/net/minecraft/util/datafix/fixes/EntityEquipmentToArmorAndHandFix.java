...
public class EntityEquipmentToArmorAndHandFix extends DataFix {
   ...
   private <IS> TypeRewriteRule cap(Type<IS> p_15427_) {
      ...
      Type<Pair<Either<List<IS>, Unit>, Pair<Either<List<IS>, Unit>, Dynamic<?>>>> type1 = DSL.and(
         DSL.optional(DSL.field("ArmorItems", DSL.list(p_15427_))), DSL.optional(DSL.field("HandItems", DSL.list(p_15427_))), DSL.remainderType()
      );
      ...
      return this.fixTypeEverywhereTyped(
         ...
         p_15425_ -> {
            ...
            if (optional.isPresent()) {
               ...
               IS is = (IS)((Pair)p_15427_.read(dynamic.emptyMap())
                     .result()
