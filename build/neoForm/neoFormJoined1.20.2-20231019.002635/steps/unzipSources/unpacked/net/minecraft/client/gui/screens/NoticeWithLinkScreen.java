...
public class NoticeWithLinkScreen extends Screen {
   ...
   public NoticeWithLinkScreen(Component p_294500_, Component p_296071_, String p_294439_, @Nullable Screen p_294155_) {
      super(p_294500_);
      this.message = p_296071_;
      this.url = p_294439_;
      this.callbackScreen = p_294155_;
   }

   public static Screen createWorldSymlinkWarningScreen(@Nullable Screen p_295935_) {
      return new NoticeWithLinkScreen(SYMLINK_WORLD_TITLE, SYMLINK_WORLD_MESSAGE_TEXT, "https://aka.ms/MinecraftSymLinks", p_295935_);
   }

   public static Screen createPackSymlinkWarningScreen(@Nullable Screen p_294229_) {
      return new NoticeWithLinkScreen(SYMLINK_PACK_TITLE, SYMLINK_PACK_MESSAGE_TEXT, "https://aka.ms/MinecraftSymLinks", p_294229_);
   }
   ...
   protected void init() {
      ...
      gridlayout$rowhelper1.addChild(
         Button.builder(CommonComponents.GUI_COPY_LINK_TO_CLIPBOARD, p_295125_ -> this.minecraft.keyboardHandler.setClipboard(this.url)).size(120, 20).build()
      );
