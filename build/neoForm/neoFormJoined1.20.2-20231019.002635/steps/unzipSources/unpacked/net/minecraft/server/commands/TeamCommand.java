                  ...
                  .then(
                     Commands.argument("team", TeamArgument.team())
                        .executes(
                           p_138987_ -> joinTeam(
                                 p_138987_.getSource(),
                                 TeamArgument.getTeam(p_138987_, "team"),
                                 Collections.singleton(p_138987_.getSource().getEntityOrException().getScoreboardName())
                              )
                        )
                        .then(
                           ...
                           Commands.literal("color")
                              .then(
                                 Commands.argument("value", ColorArgument.color())
                                    .executes(
                                       p_138979_ -> setColor(
                                             p_138979_.getSource(), TeamArgument.getTeam(p_138979_, "team"), ColorArgument.getColor(p_138979_, "value")
                                          )
                                    )
                              )
                        )
                                 ...
                                 Commands.argument("allowed", BoolArgumentType.bool())
                                    .executes(
                                       p_138977_ -> setFriendlyFire(
                                             p_138977_.getSource(), TeamArgument.getTeam(p_138977_, "team"), BoolArgumentType.getBool(p_138977_, "allowed")
                                          )
                                    )
                              )
                        )
                                 ...
                                 Commands.argument("allowed", BoolArgumentType.bool())
                                    .executes(
                                       p_138975_ -> setFriendlySight(
                                             p_138975_.getSource(), TeamArgument.getTeam(p_138975_, "team"), BoolArgumentType.getBool(p_138975_, "allowed")
                                          )
                                    )
                              )
                        )
                           ...
                           Commands.literal("nametagVisibility")
                              .then(
                                 Commands.literal("never")
                                    .executes(
                                       p_138973_ -> setNametagVisibility(p_138973_.getSource(), TeamArgument.getTeam(p_138973_, "team"), Team.Visibility.NEVER)
                                    )
                              )
                              .then(
                              ...
                              .then(
                                 Commands.literal("always")
                                    .executes(
                                       p_138967_ -> setNametagVisibility(p_138967_.getSource(), TeamArgument.getTeam(p_138967_, "team"), Team.Visibility.ALWAYS)
                                    )
                              )
                        )
                        .then(
                        ...
                        .then(
                           Commands.literal("collisionRule")
                              .then(
                                 Commands.literal("never")
                                    .executes(
                                       p_138957_ -> setCollision(p_138957_.getSource(), TeamArgument.getTeam(p_138957_, "team"), Team.CollisionRule.NEVER)
                                    )
                              )
                              .then(
                              ...
                              .then(
                                 Commands.literal("always")
                                    .executes(
                                       p_138951_ -> setCollision(p_138951_.getSource(), TeamArgument.getTeam(p_138951_, "team"), Team.CollisionRule.ALWAYS)
                                    )
                              )
                        )
                        .then(
   ...
   private static int joinTeam(CommandSourceStack p_138895_, PlayerTeam p_138896_, Collection<String> p_138897_) {
      ...
      if (p_138897_.size() == 1) {
         p_138895_.sendSuccess(
            () -> Component.translatable("commands.team.join.success.single", p_138897_.iterator().next(), p_138896_.getFormattedDisplayName()), true
         );
      } else {
