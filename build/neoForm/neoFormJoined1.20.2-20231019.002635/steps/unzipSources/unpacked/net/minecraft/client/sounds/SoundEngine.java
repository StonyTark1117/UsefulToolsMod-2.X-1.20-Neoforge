                  ...
                  if (sound == SoundManager.EMPTY_SOUND) {
                     ...
                     if (f2 == 0.0F && !p_120313_.canStartSilent()) {
                        ...
                        if (!this.listeners.isEmpty()) {
                           boolean flag1 = flag
                              || soundinstance$attenuation == SoundInstance.Attenuation.NONE
                              || this.listener.getListenerPosition().distanceToSqr(vec3) < (double)(f1 * f1);
                           if (flag1) {
                        ...
                        if (this.listener.getGain() <= 0.0F) {
                           ...
                           if (channelaccess$channelhandle == null) {
                              ...
                              if (!flag3) {
                                 this.soundBuffers.getCompleteBuffer(sound.getPath()).thenAccept(p_194501_ -> channelaccess$channelhandle.execute(p_194495_ -> {
                                 ...
                                 soundinstance
                                       .getStream(this.soundBuffers, sound, flag2)
