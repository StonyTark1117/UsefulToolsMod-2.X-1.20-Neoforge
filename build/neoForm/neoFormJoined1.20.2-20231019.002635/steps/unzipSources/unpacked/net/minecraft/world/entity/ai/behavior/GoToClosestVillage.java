   ...
   public static BehaviorControl<Villager> create(float p_260342_, int p_259691_) {
      return BehaviorBuilder.create(
         p_258357_ -> p_258357_.group(p_258357_.absent(MemoryModuleType.WALK_TARGET))
               .apply(p_258357_, p_258366_ -> (p_274970_, p_274971_, p_274972_) -> {
                     if (p_274970_.isVillage(p_274971_.blockPosition())) {
                        ...
                        for(int j = 0; j < 5; ++j) {
                           Vec3 vec31 = LandRandomPos.getPos(p_274971_, 15, 7, p_147554_ -> (double)(-poimanager.sectionsToVillage(SectionPos.of(p_147554_))));
                           if (vec31 != null) {
