   ...
   static <T extends Number, R extends MinMaxBounds<T>> Codec<R> createCodec(Codec<T> p_298521_, MinMaxBounds.BoundsFactory<T, R> p_298688_) {
      Codec<R> codec = RecordCodecBuilder.create(
         p_298327_ -> p_298327_.group(
                  ExtraCodecs.strictOptionalField(p_298521_, "min").forGetter(MinMaxBounds::min),
                  ExtraCodecs.strictOptionalField(p_298521_, "max").forGetter(MinMaxBounds::max)
               )
               .apply(p_298327_, p_298688_::create)
      );
      return Codec.either(codec, p_298521_)
         .xmap(
            p_298558_ -> p_298558_.map(
                  (Function<? super R, ? extends R>)(p_299210_ -> p_299210_), p_298935_ -> p_298688_.create(Optional.of(p_298935_), Optional.of(p_298935_))
               ),
            p_298447_ -> {
