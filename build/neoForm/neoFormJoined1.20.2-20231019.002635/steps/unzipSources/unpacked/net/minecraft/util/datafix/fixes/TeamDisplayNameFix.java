   ...
   protected TypeRewriteRule makeRule() {
      ...
      if (!Objects.equals(type, this.getInputSchema().getType(References.TEAM))) {
         ...
         return this.fixTypeEverywhere(
            "TeamDisplayNameFix",
            type,
            p_17011_ -> p_145726_ -> p_145726_.mapSecond(
                     p_145728_ -> p_145728_.update(
                           "DisplayName",
                           p_145731_ -> DataFixUtils.orElse(
                                 p_145731_.asString()
                                    .map(p_145733_ -> Component.Serializer.toJson(Component.literal(p_145733_)))
                                    .map(p_145728_::createString)
                                    .result(),
                                 p_145731_
                              )
                        )
