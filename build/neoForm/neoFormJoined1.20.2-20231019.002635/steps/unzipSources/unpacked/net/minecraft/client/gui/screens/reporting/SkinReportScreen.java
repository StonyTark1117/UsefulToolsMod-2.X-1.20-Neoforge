...
public class SkinReportScreen extends AbstractReportScreen<SkinReport.Builder> {
   ...
   protected void init() {
      ...
      linearlayout2.addChild(Button.builder(CommonComponents.GUI_BACK, p_301661_ -> this.onClose()).width(120).build());
      this.sendButton = linearlayout2.addChild(Button.builder(SEND_REPORT, p_299925_ -> this.sendReport()).width(120).build());
