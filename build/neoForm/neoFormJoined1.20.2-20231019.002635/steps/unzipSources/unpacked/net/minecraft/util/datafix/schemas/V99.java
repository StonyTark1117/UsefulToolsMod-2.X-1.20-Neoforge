...
public class V99 extends Schema {
      ...
      p_18305_.register(
         ...
         p_18245_ -> DSL.optionalFields(
               ...
               DSL.optionalFields(
                  ...
                  DSL.list(
                     DSL.optionalFields(
                        "buy", References.ITEM_STACK.in(p_18305_), "buyB", References.ITEM_STACK.in(p_18305_), "sell", References.ITEM_STACK.in(p_18305_)
                     )
                  )
               ),
               equipment(p_18305_)
   ...
   public void registerTypes(Schema p_18307_, Map<String, Supplier<TypeTemplate>> p_18308_, Map<String, Supplier<TypeTemplate>> p_18309_) {
      ...
      p_18307_.registerType(true, References.BLOCK_ENTITY, () -> DSL.taggedChoiceLazy("id", DSL.string(), p_18309_));
      p_18307_.registerType(
      ...
      p_18307_.registerType(
         ...
         () -> DSL.hook(
               DSL.optionalFields(
                  ...
                  DSL.optionalFields(
                     "EntityTag",
                     References.ENTITY_TREE.in(p_18307_),
                     "BlockEntityTag",
                     References.BLOCK_ENTITY.in(p_18307_),
                     "CanDestroy",
                     DSL.list(References.BLOCK_NAME.in(p_18307_)),
                     "CanPlaceOn",
                     DSL.list(References.BLOCK_NAME.in(p_18307_)),
                     "Items",
                     DSL.list(References.ITEM_STACK.in(p_18307_))
                  )
               ),
               ADD_NAMES,
