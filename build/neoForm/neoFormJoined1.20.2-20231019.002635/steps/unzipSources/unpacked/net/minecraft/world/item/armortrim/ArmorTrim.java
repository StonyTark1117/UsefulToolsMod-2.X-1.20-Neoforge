...
public class ArmorTrim {
   ...
   public boolean equals(Object p_267123_) {
      if (!(p_267123_ instanceof ArmorTrim)) {
         return false;
      } else {
         ArmorTrim armortrim = (ArmorTrim)p_267123_;
   ...
   public static Optional<ArmorTrim> getTrim(RegistryAccess p_266952_, ItemStack p_266766_, boolean p_294831_) {
      if (p_266766_.is(ItemTags.TRIMMABLE_ARMOR) && p_266766_.getTag() != null && p_266766_.getTag().contains("Trim")) {
         ...
         ArmorTrim armortrim = CODEC.parse(RegistryOps.create(NbtOps.INSTANCE, p_266952_), compoundtag).resultOrPartial(p_294057_ -> {
            if (!p_294831_) {
