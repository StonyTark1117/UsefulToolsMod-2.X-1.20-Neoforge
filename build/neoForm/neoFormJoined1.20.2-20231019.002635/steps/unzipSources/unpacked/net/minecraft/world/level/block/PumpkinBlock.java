      ...
      if (itemstack.canPerformAction(net.neoforged.neoforge.common.ToolActions.SHEARS_CARVE)) {
         if (!p_55290_.isClientSide) {
            ...
            ItemEntity itementity = new ItemEntity(
               p_55290_,
               (double)p_55291_.getX() + 0.5 + (double)direction1.getStepX() * 0.65,
               (double)p_55291_.getY() + 0.1,
               (double)p_55291_.getZ() + 0.5 + (double)direction1.getStepZ() * 0.65,
               new ItemStack(Items.PUMPKIN_SEEDS, 4)
            );
            itementity.setDeltaMovement(
               0.05 * (double)direction1.getStepX() + p_55290_.random.nextDouble() * 0.02,
               0.05,
               0.05 * (double)direction1.getStepZ() + p_55290_.random.nextDouble() * 0.02
            );
            p_55290_.addFreshEntity(itementity);
            itemstack.hurtAndBreak(1, p_55292_, p_55287_ -> p_55287_.broadcastBreakEvent(p_55293_));
