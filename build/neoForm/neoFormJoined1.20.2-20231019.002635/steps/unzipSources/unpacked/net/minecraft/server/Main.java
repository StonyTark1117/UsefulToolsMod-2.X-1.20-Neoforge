...
public class Main {
   ...
   public static void main(String[] p_129699_) throws Exception {
      ...
      try {
         ...
         WorldStem worldstem;
         try {
            WorldLoader.InitConfig worldloader$initconfig = loadOrCreateConfig(
               dedicatedserversettings.getProperties(), levelstoragesource$levelstorageaccess, flag, packrepository
            );
            worldstem = Util.<WorldStem>blockUntilDone(
                  p_248086_ -> WorldLoader.load(
                        ...
                        p_248079_ -> {
                           ...
                           Pair<WorldData, WorldDimensions.Complete> pair = levelstoragesource$levelstorageaccess.getDataTag(
                              dynamicops, p_248079_.dataConfiguration(), registry, p_248079_.datapackWorldgen().allRegistriesLifecycle()
                           );
                           if (pair != null) {
   ...
   private static WorldLoader.InitConfig loadOrCreateConfig(
      DedicatedServerProperties p_248563_, LevelStorageSource.LevelStorageAccess p_251359_, boolean p_249093_, PackRepository p_251069_
   ) {
   ...
   private static void forceUpgrade(
      LevelStorageSource.LevelStorageAccess p_195489_, DataFixer p_195490_, boolean p_195491_, BooleanSupplier p_195492_, Registry<LevelStem> p_250443_
   ) {
