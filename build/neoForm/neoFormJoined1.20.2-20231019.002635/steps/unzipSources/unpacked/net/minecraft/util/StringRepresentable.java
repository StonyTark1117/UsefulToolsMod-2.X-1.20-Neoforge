...
public interface StringRepresentable {
   ...
   static <E extends Enum<E> & StringRepresentable> StringRepresentable.EnumCodec<E> fromEnum(Supplier<E[]> p_216440_) {
      return fromEnumWithMapping(p_216440_, p_275327_ -> p_275327_);
   }
   ...
   static <E extends Enum<E> & StringRepresentable> StringRepresentable.EnumCodec<E> fromEnumWithMapping(
      ...
      if (ae.length > 16) {
         Map<String, E> map = Arrays.stream(ae)
            .collect(
               Collectors.toMap(
                  p_274905_ -> p_275259_.apply(((StringRepresentable)p_274905_).getSerializedName()),
                  p_274903_ -> p_274903_
               )
            );
         return new StringRepresentable.EnumCodec<>(ae, p_216438_ -> p_216438_ == null ? null : map.get(p_216438_));
      } else {
   ...
   public static class EnumCodec<E extends Enum<E> & StringRepresentable> implements Codec<E> {
      ...
      public EnumCodec(E[] p_216447_, Function<String, E> p_216448_) {
         this.codec = ExtraCodecs.orCompressed(
            ExtraCodecs.stringResolverCodec(p_216461_ -> p_216461_.getSerializedName(), p_216448_),
            ExtraCodecs.idResolverCodec(
               p_216454_ -> p_216454_.ordinal(), p_216459_ -> p_216459_ >= 0 && p_216459_ < p_216447_.length ? p_216447_[p_216459_] : null, -1
            )
         );
