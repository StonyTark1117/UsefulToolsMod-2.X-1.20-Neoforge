...
public class MerchantOffer {
   ...
   private MerchantOffer(MerchantOffer p_302340_) {
      this.baseCostA = p_302340_.baseCostA.copy();
      this.costB = p_302340_.costB.copy();
      this.result = p_302340_.result.copy();
      this.uses = p_302340_.uses;
      this.maxUses = p_302340_.maxUses;
      this.rewardExp = p_302340_.rewardExp;
      this.specialPriceDiff = p_302340_.specialPriceDiff;
      this.demand = p_302340_.demand;
      this.priceMultiplier = p_302340_.priceMultiplier;
      this.xp = p_302340_.xp;
   }
   ...
   public boolean satisfiedBy(ItemStack p_45356_, ItemStack p_45357_) {
      return this.isRequiredItem(p_45356_, this.getCostA())
         && p_45356_.getCount() >= this.getCostA().getCount()
         && this.isRequiredItem(p_45357_, this.costB)
         && p_45357_.getCount() >= this.costB.getCount();
   }
   ...
   private boolean isRequiredItem(ItemStack p_45366_, ItemStack p_45367_) {
      if (p_45367_.isEmpty() && p_45366_.isEmpty()) {
         ...
         return ItemStack.isSameItem(itemstack, p_45367_)
            && (!p_45367_.hasTag() || itemstack.hasTag() && NbtUtils.compareNbt(p_45367_.getTag(), itemstack.getTag(), false));
      }
   }
