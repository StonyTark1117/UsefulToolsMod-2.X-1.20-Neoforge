...
public class ServerLoginPacketListenerImpl implements ServerLoginPacketListener, TickablePacketListener {
   ...
   protected static GameProfile createOfflineProfile(String p_294346_) {
      UUID uuid = UUIDUtil.createOfflinePlayerUUID(p_294346_);
      return new GameProfile(uuid, p_294346_);
   }
