...
public class HttpUtil {
   ...
   public static CompletableFuture<?> downloadTo(
      File p_216226_, URL p_216227_, Map<String, String> p_216228_, int p_216229_, @Nullable ProgressListener p_216230_, Proxy p_216231_
   ) {
      return CompletableFuture.supplyAsync(() -> {
         ...
         try {
            ...
            for(Entry<String, String> entry : p_216228_.entrySet()) {
