...
public abstract class Raider extends PatrollingMonster {
   ...
   static final Predicate<ItemEntity> ALLOWED_ITEMS = p_302220_ -> !p_302220_.hasPickUpDelay()
         && p_302220_.isAlive()
         && ItemStack.matches(p_302220_.getItem(), Raid.getLeaderBannerInstance());
   @Nullable
   protected Raid raid;
   private int wave;
   ...
   public SpawnGroupData finalizeSpawn(
      ServerLevelAccessor p_37856_, DifficultyInstance p_37857_, MobSpawnType p_37858_, @Nullable SpawnGroupData p_37859_, @Nullable CompoundTag p_37860_
   ) {
