...
public class Phantom extends FlyingMob implements Enemy {
   ...
   public SpawnGroupData finalizeSpawn(
      ServerLevelAccessor p_33126_, DifficultyInstance p_33127_, MobSpawnType p_33128_, @Nullable SpawnGroupData p_33129_, @Nullable CompoundTag p_33130_
   ) {
   ...
   @Override
   protected Vector3f getPassengerAttachmentPoint(Entity p_295517_, EntityDimensions p_296113_, float p_296357_) {
      return new Vector3f(0.0F, p_296113_.height * 0.675F, 0.0F);
   }

   @Override
   protected float ridingOffset(Entity p_294664_) {
      return -0.125F;
   }
