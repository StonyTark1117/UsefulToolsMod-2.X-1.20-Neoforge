...
public class ScoreboardNameProviders {
   ...
   private static LootScoreProviderType register(String p_165874_, Codec<? extends ScoreboardNameProvider> p_298296_) {
      return Registry.register(BuiltInRegistries.LOOT_SCORE_PROVIDER_TYPE, new ResourceLocation(p_165874_), new LootScoreProviderType(p_298296_));
   }
}
