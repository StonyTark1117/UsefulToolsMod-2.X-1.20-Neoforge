...
public class EntityRenderDispatcher implements ResourceManagerReloadListener {
   ...
   private static void renderHitbox(PoseStack p_114442_, VertexConsumer p_114443_, Entity p_114444_, float p_114445_) {
      ...
      p_114443_.vertex(matrix4f, 0.0F, p_114444_.getEyeHeight(), 0.0F)
         .color(0, 0, 255, 255)
         .normal(matrix3f, (float)vec31.x, (float)vec31.y, (float)vec31.z)
         .endVertex();
      p_114443_.vertex(matrix4f, (float)(vec31.x * 2.0), (float)((double)p_114444_.getEyeHeight() + vec31.y * 2.0), (float)(vec31.z * 2.0))
         .color(0, 0, 255, 255)
         .normal(matrix3f, (float)vec31.x, (float)vec31.y, (float)vec31.z)
         .endVertex();
   }
   ...
   private static void fireVertex(
      ...
      p_114416_.vertex(p_114415_.pose(), p_114417_, p_114418_, p_114419_)
   ...
   private static void renderShadow(
      ...
      float f = p_114464_;
      if (p_114460_ instanceof Mob mob && mob.isBaby()) {
         f = p_114464_ * 0.5F;
      }
   ...
   private static void shadowVertex(
      PoseStack.Pose p_114423_, VertexConsumer p_114424_, float p_114425_, float p_114426_, float p_114427_, float p_114428_, float p_114429_, float p_114430_
   ) {
