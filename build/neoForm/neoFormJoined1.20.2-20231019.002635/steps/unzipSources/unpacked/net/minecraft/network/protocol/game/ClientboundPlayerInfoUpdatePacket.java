...
public class ClientboundPlayerInfoUpdatePacket implements Packet<ClientGamePacketListener> {
   ...
   public ClientboundPlayerInfoUpdatePacket(FriendlyByteBuf p_251820_) {
      ...
      this.entries = p_251820_.readList(
         p_249950_ -> {
   ...
   public static enum Action {
      ...
      UPDATE_LISTED((p_248777_, p_248837_) -> p_248777_.listed = p_248837_.readBoolean(), (p_293734_, p_293735_) -> p_293734_.writeBoolean(p_293735_.listed())),
      ...
      UPDATE_DISPLAY_NAME(
         (p_248840_, p_251000_) -> p_248840_.displayName = p_251000_.readNullable(FriendlyByteBuf::readComponent),
