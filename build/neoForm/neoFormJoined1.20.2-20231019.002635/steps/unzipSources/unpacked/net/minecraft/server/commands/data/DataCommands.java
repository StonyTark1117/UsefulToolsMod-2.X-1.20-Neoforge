...
public class DataCommands {
   ...
   private static final DynamicCommandExceptionType ERROR_GET_NOT_NUMBER = new DynamicCommandExceptionType(
      p_139491_ -> Component.translatable("commands.data.get.invalid", p_139491_)
   );
   private static final DynamicCommandExceptionType ERROR_GET_NON_EXISTENT = new DynamicCommandExceptionType(
      p_139481_ -> Component.translatable("commands.data.get.unknown", p_139481_)
   );
   ...
   private static final DynamicCommandExceptionType ERROR_EXPECTED_OBJECT = new DynamicCommandExceptionType(
      p_139448_ -> Component.translatable("commands.data.modify.expected_object", p_139448_)
   );
   private static final DynamicCommandExceptionType ERROR_EXPECTED_VALUE = new DynamicCommandExceptionType(
      p_264853_ -> Component.translatable("commands.data.modify.expected_value", p_264853_)
   );
   private static final Dynamic2CommandExceptionType ERROR_INVALID_SUBSTRING = new Dynamic2CommandExceptionType(
      (p_288740_, p_288741_) -> Component.translatable("commands.data.modify.invalid_substring", p_288740_, p_288741_)
   );
                  ...
                  (p_139368_, p_139369_) -> p_139368_.then(
                        ...
                        .then(
                           Commands.literal("set")
                              .then(p_139369_.create((p_142835_, p_142836_, p_142837_, p_142838_) -> p_142837_.set(p_142836_, Iterables.getLast(p_142838_))))
                        )
   ...
   public interface DataProvider {
      ...
      ArgumentBuilder<CommandSourceStack, ?> wrap(
         ArgumentBuilder<CommandSourceStack, ?> p_139502_, Function<ArgumentBuilder<CommandSourceStack, ?>, ArgumentBuilder<CommandSourceStack, ?>> p_139503_
      );
   }
