...
public class BlockModelGenerators {
      ...
      return MultiVariantGenerator.multiVariant(p_124925_)
         .with(
            PropertyDispatch.property(BlockStateProperties.AXIS)
               ...
               .select(
                  Direction.Axis.Z, Variant.variant().with(VariantProperties.MODEL, p_124927_).with(VariantProperties.X_ROT, VariantProperties.Rotation.R90)
               )
               .select(
                  Direction.Axis.X,
                  Variant.variant()
            ...
            MultiVariantGenerator.multiVariant(p_124987_)
               .with(
                  PropertyDispatch.property(BlockStateProperties.FACING)
                     .select(
                        Direction.DOWN,
                        Variant.variant().with(VariantProperties.MODEL, resourcelocation1).with(VariantProperties.X_ROT, VariantProperties.Rotation.R180)
                     )
   ...
   private void createAmethystCluster(Block p_176252_) {
      ...
      this.blockStateOutput
         .accept(
            MultiVariantGenerator.multiVariant(
                  p_176252_,
                  Variant.variant().with(VariantProperties.MODEL, ModelTemplates.CROSS.create(p_176252_, TextureMapping.cross(p_176252_), this.modelOutput))
               )
               .with(this.createColumnWithFacing())
         );
   }
   ...
   private void createLantern(Block p_125005_) {
      ...
      this.blockStateOutput
         .accept(
            MultiVariantGenerator.multiVariant(p_125005_).with(createBooleanModelDispatch(BlockStateProperties.HANGING, resourcelocation1, resourcelocation))
         );
   }
   ...
   private void createWeightedPressurePlate(Block p_124919_, Block p_124920_) {
      ...
      this.blockStateOutput
         .accept(
            MultiVariantGenerator.multiVariant(p_124919_).with(createEmptyOrFullDispatch(BlockStateProperties.POWER, 1, resourcelocation1, resourcelocation))
         );
   }
               ...
               .with(
                  PropertyDispatch.properties(BlockStateProperties.SHORT, BlockStateProperties.PISTON_TYPE)
                     .select(
                        ...
                        Variant.variant()
                           .with(
                              VariantProperties.MODEL, ModelTemplates.PISTON_HEAD.createWithSuffix(Blocks.PISTON, "_head", texturemapping2, this.modelOutput)
                           )
                     )
                     .select(
                        false,
                  ...
                  PropertyDispatch.property(BlockStateProperties.SCULK_SENSOR_PHASE)
                     .generate(
                        p_284650_ -> Variant.variant()
                              .with(
                                 VariantProperties.MODEL,
                                 p_284650_ != SculkSensorPhase.ACTIVE && p_284650_ != SculkSensorPhase.COOLDOWN ? resourcelocation : resourcelocation1
                              )
                     )
               )
         );
                  ...
                  PropertyDispatch.property(BlockStateProperties.SCULK_SENSOR_PHASE)
                     .generate(
                        p_284647_ -> Variant.variant()
                              .with(
                                 VariantProperties.MODEL,
                                 p_284647_ != SculkSensorPhase.ACTIVE && p_284647_ != SculkSensorPhase.COOLDOWN ? resourcelocation : resourcelocation1
                              )
                     )
               )
               .with(createHorizontalFacingDispatch())
   ...
   private void createNormalTorch(Block p_124951_, Block p_124952_) {
      ...
      this.blockStateOutput
         .accept(
            MultiVariantGenerator.multiVariant(
                  p_124952_, Variant.variant().with(VariantProperties.MODEL, ModelTemplates.WALL_TORCH.create(p_124952_, texturemapping, this.modelOutput))
               )
   ...
   class BlockFamilyProvider {
      ...
      public BlockModelGenerators.BlockFamilyProvider customFence(Block p_250333_) {
         ...
         BlockModelGenerators.this.blockStateOutput
            .accept(
               BlockModelGenerators.createCustomFence(p_250333_, resourcelocation, resourcelocation1, resourcelocation2, resourcelocation3, resourcelocation4)
            );
      ...
      private BlockModelGenerators.BlockFamilyProvider fullBlockVariant(Block p_176272_) {
         ...
         BlockModelGenerators.this.blockStateOutput
            .accept(BlockModelGenerators.createSimpleBlock(p_176272_, texturedmodel.create(p_176272_, BlockModelGenerators.this.modelOutput)));
         return this;
      }
