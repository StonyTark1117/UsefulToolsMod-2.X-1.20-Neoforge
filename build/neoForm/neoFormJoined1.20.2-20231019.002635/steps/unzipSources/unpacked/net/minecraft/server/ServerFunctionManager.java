...
public class ServerFunctionManager {
   ...
   public int execute(CommandFunction p_136113_, CommandSourceStack p_136114_) {
      try {
         return this.execute(p_136113_, p_136114_, null, null);
   ...
   public int execute(
      CommandFunction p_179961_, CommandSourceStack p_179962_, @Nullable ServerFunctionManager.TraceCallbacks p_179963_, @Nullable CompoundTag p_295910_
   ) throws FunctionInstantiationException {
      CommandFunction commandfunction = p_179961_.instantiate(p_295910_, this.getDispatcher(), p_179962_);
   ...
   class ExecutionContext {
      ...
      private CommandSourceStack wrapSender(CommandSourceStack p_282848_) {
         ...
         return intconsumer instanceof ServerFunctionManager.ExecutionContext.AbortingReturnValueConsumer
            ? p_282848_
            : p_282848_.withReturnValueConsumer(new ServerFunctionManager.ExecutionContext.AbortingReturnValueConsumer(intconsumer));
      }
   ...
   public static class QueuedCommand {
      ...
      public void execute(
         ServerFunctionManager p_179986_,
         Deque<ServerFunctionManager.QueuedCommand> p_179987_,
         int p_179988_,
         @Nullable ServerFunctionManager.TraceCallbacks p_179989_
      ) {
         try {
