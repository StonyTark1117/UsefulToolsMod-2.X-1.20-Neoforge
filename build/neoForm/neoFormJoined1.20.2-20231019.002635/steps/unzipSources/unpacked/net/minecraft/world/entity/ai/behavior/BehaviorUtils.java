...
public class BehaviorUtils {
   ...
   public static boolean targetIsValid(Brain<?> p_22640_, MemoryModuleType<? extends LivingEntity> p_22641_, EntityType<?> p_22642_) {
      return targetIsValid(p_22640_, p_22641_, p_302163_ -> p_302163_.getType() == p_22642_);
   }
   ...
   public static boolean isWithinAttackRange(Mob p_22633_, LivingEntity p_22634_, int p_22635_) {
      ...
      if ($$4 instanceof ProjectileWeaponItem projectileweaponitem && p_22633_.canFireProjectileWeapon(projectileweaponitem)) {
   ...
   public static Optional<LivingEntity> getLivingEntityFromUUIDMemory(LivingEntity p_22611_, MemoryModuleType<UUID> p_22612_) {
      ...
      return optional.<Entity>map(p_301747_ -> ((ServerLevel)p_22611_.level()).getEntity(p_301747_))
      ...
      while(
         vec3 != null
            && !p_147445_.level()
               ...
               .isPathfindable(p_147445_.level(), BlockPos.containing(vec3), PathComputationType.WATER)
            && i++ < 10
      ) {
