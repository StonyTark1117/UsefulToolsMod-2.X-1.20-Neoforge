   ...
   public static BehaviorControl<LivingEntity> create() {
      return BehaviorBuilder.create(
         p_260168_ -> p_260168_.group(
               ...
               .apply(p_260168_, (p_259214_, p_260031_) -> (p_302211_, p_302212_, p_302213_) -> {
                     LivingEntity livingentity = p_260168_.get(p_259214_);
                     if (livingentity.getType() == EntityType.HOGLIN && livingentity.isDeadOrDying()) {
                        p_260031_.setWithExpiry(true, (long)PiglinAi.TIME_BETWEEN_HUNTS.sample(p_302212_.level().random));
                     }
