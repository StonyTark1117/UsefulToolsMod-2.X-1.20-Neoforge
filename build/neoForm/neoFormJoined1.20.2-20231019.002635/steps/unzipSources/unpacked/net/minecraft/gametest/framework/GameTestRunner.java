...
public class GameTestRunner {
   ...
   public static Collection<GameTestInfo> runTestBatches(
      Collection<GameTestBatch> p_127727_, BlockPos p_127728_, Rotation p_127729_, ServerLevel p_127730_, GameTestTicker p_127731_, int p_127732_
   ) {
   ...
   public static void clearAllTests(ServerLevel p_127695_, BlockPos p_127696_, GameTestTicker p_127697_, int p_127698_) {
      ...
      BlockPos.betweenClosedStream(blockpos, blockpos1)
         .filter(p_177540_ -> p_127695_.getBlockState(p_177540_).is(Blocks.STRUCTURE_BLOCK))
         .forEach(p_177529_ -> {
