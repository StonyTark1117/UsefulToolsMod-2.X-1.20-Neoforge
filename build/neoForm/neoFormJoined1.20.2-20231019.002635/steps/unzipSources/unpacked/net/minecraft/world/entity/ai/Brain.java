...
public class Brain<E extends LivingEntity> {
   ...
   public boolean checkMemory(MemoryModuleType<?> p_21877_, MemoryStatus p_21878_) {
      ...
      if (optional == null) {
         ...
         return p_21878_ == MemoryStatus.REGISTERED
               ...
               p_22053_ -> this.value
                     .ifPresent(
                        p_258258_ -> p_22049_.add(
                              BuiltInRegistries.MEMORY_MODULE_TYPE.byNameCodec().encodeStart(p_22048_, this.type), p_22053_.encodeStart(p_22048_, p_258258_)
                           )
                     )
            );
      }
