...
public class RegistryCodecs {
   private static <T> MapCodec<RegistryCodecs.RegistryEntry<T>> withNameAndId(ResourceKey<? extends Registry<T>> p_206304_, MapCodec<T> p_206305_) {
      return RecordCodecBuilder.mapCodec(
         p_206309_ -> p_206309_.group(
                  ResourceKey.codec(p_206304_).fieldOf("name").forGetter(RegistryCodecs.RegistryEntry::key),
                  Codec.INT.fieldOf("id").forGetter(RegistryCodecs.RegistryEntry::id),
                  p_206305_.forGetter(RegistryCodecs.RegistryEntry::value)
               )
   ...
   public static <T> Codec<Registry<T>> networkCodec(ResourceKey<? extends Registry<T>> p_206292_, Lifecycle p_206293_, Codec<T> p_206294_) {
      return withNameAndId(p_206292_, p_206294_.fieldOf("element")).codec().listOf().xmap(p_297933_ -> {
