...
class AbsorptionMobEffect extends MobEffect {
   ...
   @Override
   public void applyEffectTick(LivingEntity p_294484_, int p_294672_) {
      super.applyEffectTick(p_294484_, p_294672_);
      if (p_294484_.getAbsorptionAmount() <= 0.0F && !p_294484_.level().isClientSide) {
         p_294484_.removeEffect(this);
      }
   }
