...
public class AdvancementCommands {
                                 ...
                                 Commands.argument("advancement", ResourceLocationArgument.id())
                                    ...
                                    .executes(
                                       p_300759_ -> perform(
                                             ...
                                             getAdvancements(
                                                p_300759_, ResourceLocationArgument.getAdvancement(p_300759_, "advancement"), AdvancementCommands.Mode.ONLY
                                             )
                                          )
                                    )
                                    .then(
                                       Commands.argument("criterion", StringArgumentType.greedyString())
                                          .suggests(
                                             (p_300739_, p_300740_) -> SharedSuggestionProvider.suggest(
                                                   ResourceLocationArgument.getAdvancement(p_300739_, "advancement").value().criteria().keySet(), p_300740_
                                                )
                                          )
                                          .executes(
                                 ...
                                 Commands.argument("advancement", ResourceLocationArgument.id())
                                    ...
                                    .executes(
                                       p_300760_ -> perform(
                                             ...
                                             AdvancementCommands.Action.GRANT,
                                             getAdvancements(
                                                p_300760_, ResourceLocationArgument.getAdvancement(p_300760_, "advancement"), AdvancementCommands.Mode.FROM
                                             )
                                          )
                                    )
                              )
                                 ...
                                 Commands.argument("advancement", ResourceLocationArgument.id())
                                    ...
                                    .executes(
                                       p_300749_ -> perform(
                                             ...
                                             AdvancementCommands.Action.GRANT,
                                             getAdvancements(
                                                p_300749_, ResourceLocationArgument.getAdvancement(p_300749_, "advancement"), AdvancementCommands.Mode.UNTIL
                                             )
                                          )
                                    )
                              )
                                 ...
                                 Commands.argument("advancement", ResourceLocationArgument.id())
                                    ...
                                    .executes(
                                       p_300741_ -> perform(
                                             ...
                                             AdvancementCommands.Action.GRANT,
                                             getAdvancements(
                                                p_300741_, ResourceLocationArgument.getAdvancement(p_300741_, "advancement"), AdvancementCommands.Mode.THROUGH
                                             )
                                          )
                                    )
                              )
                                 ...
                                 Commands.argument("advancement", ResourceLocationArgument.id())
                                    ...
                                    .executes(
                                       p_300745_ -> perform(
                                             ...
                                             getAdvancements(
                                                p_300745_, ResourceLocationArgument.getAdvancement(p_300745_, "advancement"), AdvancementCommands.Mode.ONLY
                                             )
                                          )
                                    )
                                    .then(
                                       Commands.argument("criterion", StringArgumentType.greedyString())
                                          .suggests(
                                             (p_300746_, p_300747_) -> SharedSuggestionProvider.suggest(
                                                   ResourceLocationArgument.getAdvancement(p_300746_, "advancement").value().criteria().keySet(), p_300747_
                                                )
                                          )
                                          .executes(
                                 ...
                                 Commands.argument("advancement", ResourceLocationArgument.id())
                                    ...
                                    .executes(
                                       p_300758_ -> perform(
                                             ...
                                             AdvancementCommands.Action.REVOKE,
                                             getAdvancements(
                                                p_300758_, ResourceLocationArgument.getAdvancement(p_300758_, "advancement"), AdvancementCommands.Mode.FROM
                                             )
                                          )
                                    )
                              )
                                 ...
                                 Commands.argument("advancement", ResourceLocationArgument.id())
                                    ...
                                    .executes(
                                       p_300738_ -> perform(
                                             ...
                                             AdvancementCommands.Action.REVOKE,
                                             getAdvancements(
                                                p_300738_, ResourceLocationArgument.getAdvancement(p_300738_, "advancement"), AdvancementCommands.Mode.UNTIL
                                             )
                                          )
                                    )
                              )
                                 ...
                                 Commands.argument("advancement", ResourceLocationArgument.id())
                                    ...
                                    .executes(
                                       p_300764_ -> perform(
                                             ...
                                             AdvancementCommands.Action.REVOKE,
                                             getAdvancements(
                                                p_300764_, ResourceLocationArgument.getAdvancement(p_300764_, "advancement"), AdvancementCommands.Mode.THROUGH
                                             )
                                          )
                                    )
                              )
            ...
            if (p_136321_.size() == 1) {
               throw new CommandRuntimeException(
                  Component.translatable(
                     p_136322_.getKey() + ".one.to.one.failure", Advancement.name(p_136323_.iterator().next()), p_136321_.iterator().next().getDisplayName()
                  )
               );
            } else {
               throw new CommandRuntimeException(
         ...
         if (p_136323_.size() == 1) {
            if (p_136321_.size() == 1) {
               p_136320_.sendSuccess(
                  () -> Component.translatable(
                        p_136322_.getKey() + ".one.to.one.success", Advancement.name(p_136323_.iterator().next()), p_136321_.iterator().next().getDisplayName()
                     ),
                  true
               );
            } else {
               p_136320_.sendSuccess(
                  () -> Component.translatable(p_136322_.getKey() + ".one.to.many.success", Advancement.name(p_136323_.iterator().next()), p_136321_.size()),
                  true
               );
            }
         } else if (p_136321_.size() == 1) {
   ...
   private static int performCriterion(
      ...
      if (!advancement.criteria().containsKey(p_136329_)) {
         throw new CommandRuntimeException(Component.translatable("commands.advancement.criterionNotFound", Advancement.name(p_301324_), p_136329_));
      } else {
         ...
         if (i == 0) {
            if (p_136326_.size() == 1) {
               throw new CommandRuntimeException(
                  Component.translatable(
                     p_136327_.getKey() + ".criterion.to.one.failure", p_136329_, Advancement.name(p_301324_), p_136326_.iterator().next().getDisplayName()
                  )
               );
            } else {
               throw new CommandRuntimeException(
            ...
            if (p_136326_.size() == 1) {
               p_136325_.sendSuccess(
                  () -> Component.translatable(
                        p_136327_.getKey() + ".criterion.to.one.success", p_136329_, Advancement.name(p_301324_), p_136326_.iterator().next().getDisplayName()
                     ),
                  true
               );
            } else {
               p_136325_.sendSuccess(
                  () -> Component.translatable(p_136327_.getKey() + ".criterion.to.many.success", p_136329_, Advancement.name(p_301324_), p_136326_.size()),
                  true
               );
            }
