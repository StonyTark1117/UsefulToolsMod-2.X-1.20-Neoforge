...
public class FishingHookRenderer extends EntityRenderer<FishingHook> {
   ...
   public void render(FishingHook p_114705_, float p_114706_, float p_114707_, PoseStack p_114708_, MultiBufferSource p_114709_, int p_114710_) {
      ...
      if (player != null) {
         ...
         float f2 = Mth.lerp(p_114707_, player.yBodyRotO, player.yBodyRot) * (float) (Math.PI / 180.0);
   ...
   private static void vertex(
      VertexConsumer p_254464_, Matrix4f p_254085_, Matrix3f p_253962_, int p_254296_, float p_253632_, int p_254132_, int p_254171_, int p_254026_
   ) {
