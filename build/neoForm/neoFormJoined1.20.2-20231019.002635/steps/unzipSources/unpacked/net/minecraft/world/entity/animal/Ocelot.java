...
public class Ocelot extends Animal {
   ...
   public SpawnGroupData finalizeSpawn(
      ServerLevelAccessor p_29007_, DifficultyInstance p_29008_, MobSpawnType p_29009_, @Nullable SpawnGroupData p_29010_, @Nullable CompoundTag p_29011_
   ) {
      if (p_29010_ == null) {
   ...
   @Override
   protected Vector3f getPassengerAttachmentPoint(Entity p_296251_, EntityDimensions p_295723_, float p_294127_) {
      return new Vector3f(0.0F, p_295723_.height - 0.0625F * p_294127_, 0.0F);
   }
