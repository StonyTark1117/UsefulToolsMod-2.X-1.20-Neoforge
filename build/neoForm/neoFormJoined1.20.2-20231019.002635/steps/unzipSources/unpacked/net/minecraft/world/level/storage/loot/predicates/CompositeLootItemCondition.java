...
public abstract class CompositeLootItemCondition implements LootItemCondition {
   ...
   protected static <T extends CompositeLootItemCondition> Codec<T> createCodec(Function<List<LootItemCondition>, T> p_298515_) {
      return RecordCodecBuilder.create(
         p_299125_ -> p_299125_.group(LootItemConditions.CODEC.listOf().fieldOf("terms").forGetter(p_298337_ -> p_298337_.terms)).apply(p_299125_, p_298515_)
      );
   }
   ...
   protected static <T extends CompositeLootItemCondition> Codec<T> createInlineCodec(Function<List<LootItemCondition>, T> p_298806_) {
      return LootItemConditions.CODEC.listOf().xmap(p_298806_, p_298237_ -> p_298237_.terms);
   }
