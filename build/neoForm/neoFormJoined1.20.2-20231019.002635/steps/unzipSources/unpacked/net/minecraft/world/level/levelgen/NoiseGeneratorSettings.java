...
public record NoiseGeneratorSettings(
   ...
   public static NoiseGeneratorSettings end(BootstapContext<?> p_256478_) {
      return new NoiseGeneratorSettings(
         ...
         NoiseRouterData.end(p_256478_.lookup(Registries.DENSITY_FUNCTION)),
         SurfaceRuleData.end(),
         List.of(),
         0,
         true,
   ...
   public static NoiseGeneratorSettings nether(BootstapContext<?> p_256180_) {
      return new NoiseGeneratorSettings(
         ...
         NoiseRouterData.nether(p_256180_.lookup(Registries.DENSITY_FUNCTION), p_256180_.lookup(Registries.NOISE)),
   ...
   public static NoiseGeneratorSettings overworld(BootstapContext<?> p_256460_, boolean p_256427_, boolean p_256318_) {
      return new NoiseGeneratorSettings(
         ...
         NoiseRouterData.overworld(p_256460_.lookup(Registries.DENSITY_FUNCTION), p_256460_.lookup(Registries.NOISE), p_256318_, p_256427_),
   ...
   public static NoiseGeneratorSettings caves(BootstapContext<?> p_255690_) {
      return new NoiseGeneratorSettings(
         ...
         Blocks.STONE.defaultBlockState(),
         Blocks.WATER.defaultBlockState(),
         NoiseRouterData.caves(p_255690_.lookup(Registries.DENSITY_FUNCTION), p_255690_.lookup(Registries.NOISE)),
   ...
   public static NoiseGeneratorSettings floatingIslands(BootstapContext<?> p_255885_) {
      return new NoiseGeneratorSettings(
         ...
         Blocks.STONE.defaultBlockState(),
         Blocks.WATER.defaultBlockState(),
         NoiseRouterData.floatingIslands(p_255885_.lookup(Registries.DENSITY_FUNCTION), p_255885_.lookup(Registries.NOISE)),
