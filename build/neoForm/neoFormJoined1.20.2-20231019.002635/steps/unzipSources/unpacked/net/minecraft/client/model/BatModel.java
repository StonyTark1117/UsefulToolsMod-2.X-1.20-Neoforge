...
public class BatModel extends HierarchicalModel<Bat> {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      partdefinition1.addOrReplaceChild(
         "left_ear", CubeListBuilder.create().texOffs(24, 0).mirror().addBox(1.0F, -6.0F, -2.0F, 3.0F, 4.0F, 1.0F), PartPose.ZERO
      );
   ...
   public void setupAnim(Bat p_102200_, float p_102201_, float p_102202_, float p_102203_, float p_102204_, float p_102205_) {
      if (p_102200_.isResting()) {
         this.head.xRot = p_102205_ * (float) (Math.PI / 180.0);
         this.head.yRot = (float) Math.PI - p_102204_ * (float) (Math.PI / 180.0);
         ...
         this.head.xRot = p_102205_ * (float) (Math.PI / 180.0);
         this.head.yRot = p_102204_ * (float) (Math.PI / 180.0);
         this.head.zRot = 0.0F;
         this.head.setPos(0.0F, 0.0F, 0.0F);
         this.rightWing.setPos(0.0F, 0.0F, 0.0F);
         this.leftWing.setPos(0.0F, 0.0F, 0.0F);
         this.body.xRot = (float) (Math.PI / 4) + Mth.cos(p_102203_ * 0.1F) * 0.15F;
         this.body.yRot = 0.0F;
         this.rightWing.yRot = Mth.cos(p_102203_ * 74.48451F * (float) (Math.PI / 180.0)) * (float) Math.PI * 0.25F;
         this.leftWing.yRot = -this.rightWing.yRot;
