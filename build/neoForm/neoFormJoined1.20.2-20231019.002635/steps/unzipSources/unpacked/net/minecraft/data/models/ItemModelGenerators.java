      ...
      if (p_267151_.getMaterial() == ArmorMaterials.LEATHER) {
         ModelTemplates.TWO_LAYERED_ITEM
            .create(
               ...
               this.output,
               (p_267902_, p_267903_) -> this.generateBaseArmorTrimTemplate(p_267902_, p_267903_, p_267151_.getMaterial())
            );
      } else {
         ModelTemplates.FLAT_ITEM
            .create(
               ...
               this.output,
               (p_267905_, p_267906_) -> this.generateBaseArmorTrimTemplate(p_267905_, p_267906_, p_267151_.getMaterial())
            );
      }
