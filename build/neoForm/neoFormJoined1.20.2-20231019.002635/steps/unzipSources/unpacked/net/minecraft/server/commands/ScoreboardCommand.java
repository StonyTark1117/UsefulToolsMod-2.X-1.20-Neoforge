...
public class ScoreboardCommand {
   ...
   private static final Dynamic2CommandExceptionType ERROR_NO_VALUE = new Dynamic2CommandExceptionType(
      (p_138534_, p_138535_) -> Component.translatable("commands.scoreboard.players.get.null", p_138534_, p_138535_)
   );
                     ...
                     Commands.literal("setdisplay")
                        .then(
                           Commands.argument("slot", ScoreboardSlotArgument.displaySlot())
                              .executes(p_293788_ -> clearDisplaySlot(p_293788_.getSource(), ScoreboardSlotArgument.getDisplaySlot(p_293788_, "slot")))
                              .then(
                                 Commands.argument("objective", ObjectiveArgument.objective())
                                    .executes(
                     ...
                     Commands.literal("list")
                        ...
                        .then(
                           Commands.argument("target", ScoreHolderArgument.scoreHolder())
                              ...
                              .executes(p_138569_ -> listTrackedPlayerScores(p_138569_.getSource(), ScoreHolderArgument.getName(p_138569_, "target")))
                        )
                  )
                  .then(
                              ...
                              .then(
                                 Commands.argument("objective", ObjectiveArgument.objective())
                                    .executes(
                                       p_138565_ -> getScore(
                                             p_138565_.getSource(),
                                             ScoreHolderArgument.getName(p_138565_, "target"),
                                             ObjectiveArgument.getObjective(p_138565_, "objective")
                                          )
                                    )
                              )
                        )
   ...
   private static int getScore(CommandSourceStack p_138499_, String p_138500_, Objective p_138501_) throws CommandSyntaxException {
      ...
      if (!scoreboard.hasPlayerScore(p_138500_, p_138501_)) {
         ...
         p_138499_.sendSuccess(
            () -> Component.translatable("commands.scoreboard.players.get.success", p_138500_, score.getScore(), p_138501_.getFormattedDisplayName()), false
         );
   ...
   private static int performOperation(
      ...
      Collection<String> p_138525_,
      Objective p_138526_,
      OperationArgument.Operation p_138527_,
      Collection<String> p_138528_,
      Objective p_138529_
      ...
      if (p_138525_.size() == 1) {
         ...
         p_138524_.sendSuccess(
            () -> Component.translatable(
                  "commands.scoreboard.players.operation.success.single", p_138526_.getFormattedDisplayName(), p_138525_.iterator().next(), j
               ),
            true
         );
      } else {
         ...
         if (i == 0) {
            ...
            if (p_138516_.size() == 1) {
               p_138515_.sendSuccess(
                  () -> Component.translatable(
                        "commands.scoreboard.players.enable.success.single", p_138517_.getFormattedDisplayName(), p_138516_.iterator().next()
                     ),
                  true
               );
            } else {
   ...
   private static int resetScores(CommandSourceStack p_138508_, Collection<String> p_138509_) {
      ...
      for(String s : p_138509_) {
         scoreboard.resetPlayerScore(s, null);
      }
   ...
   private static int resetScore(CommandSourceStack p_138541_, Collection<String> p_138542_, Objective p_138543_) {
      ...
      if (p_138542_.size() == 1) {
         p_138541_.sendSuccess(
            () -> Component.translatable("commands.scoreboard.players.reset.specific.single", p_138543_.getFormattedDisplayName(), p_138542_.iterator().next()),
            true
         );
      } else {
         p_138541_.sendSuccess(
   ...
   private static int setScore(CommandSourceStack p_138519_, Collection<String> p_138520_, Objective p_138521_, int p_138522_) {
      ...
      if (p_138520_.size() == 1) {
         p_138519_.sendSuccess(
            () -> Component.translatable(
                  "commands.scoreboard.players.set.success.single", p_138521_.getFormattedDisplayName(), p_138520_.iterator().next(), p_138522_
               ),
            true
         );
      } else {
   ...
   private static int addScore(CommandSourceStack p_138545_, Collection<String> p_138546_, Objective p_138547_, int p_138548_) {
      ...
      if (p_138546_.size() == 1) {
         ...
         p_138545_.sendSuccess(
            () -> Component.translatable(
                  "commands.scoreboard.players.add.success.single", p_138548_, p_138547_.getFormattedDisplayName(), p_138546_.iterator().next(), j
               ),
            true
         );
      } else {
   ...
   private static int removeScore(CommandSourceStack p_138554_, Collection<String> p_138555_, Objective p_138556_, int p_138557_) {
      ...
      if (p_138555_.size() == 1) {
         ...
         p_138554_.sendSuccess(
            () -> Component.translatable(
                  "commands.scoreboard.players.remove.success.single", p_138557_, p_138556_.getFormattedDisplayName(), p_138555_.iterator().next(), j
               ),
            true
         );
      } else {
      ...
      if (map.isEmpty()) {
         ...
         for(Entry<Objective, Score> entry : map.entrySet()) {
            p_138496_.sendSuccess(
               () -> Component.translatable(
                     "commands.scoreboard.players.list.entity.entry", entry.getKey().getFormattedDisplayName(), entry.getValue().getScore()
                  ),
               false
            );
         }
