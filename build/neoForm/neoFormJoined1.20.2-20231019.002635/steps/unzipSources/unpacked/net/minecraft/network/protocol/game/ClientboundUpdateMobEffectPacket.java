...
public class ClientboundUpdateMobEffectPacket implements Packet<ClientGamePacketListener> {
   ...
   public ClientboundUpdateMobEffectPacket(int p_133611_, MobEffectInstance p_133612_) {
      ...
      this.effectAmplifier = (byte)(p_133612_.getAmplifier() & 0xFF);
      ...
      this.flags = b0;
      this.factorData = p_133612_.getFactorData().orElse(null);
   }
   ...
   public ClientboundUpdateMobEffectPacket(FriendlyByteBuf p_179466_) {
      ...
      this.factorData = p_179466_.readNullable(p_293742_ -> p_293742_.readWithCodecTrusted(NbtOps.INSTANCE, MobEffectInstance.FactorData.CODEC));
   }
