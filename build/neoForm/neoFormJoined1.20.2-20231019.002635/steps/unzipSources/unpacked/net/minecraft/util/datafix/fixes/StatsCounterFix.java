...
public class StatsCounterFix extends DataFix {
   ...
   private TypeRewriteRule makeStatFixer() {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         p_293829_ -> {
            ...
            return (Typed<?>)((Pair)type1.readTyped(dynamic.emptyMap().set("stats", dynamic.createMap(map)))
                  .result()
   ...
   private TypeRewriteRule makeObjectiveFixer() {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         type1,
         p_293831_ -> {
            Dynamic<?> dynamic = p_293831_.get(DSL.remainderFinder());
            ...
            return (Typed<?>)((Pair)type1.readTyped(dynamic1).result().orElseThrow(() -> new IllegalStateException("Could not parse new objective object.")))
               .getFirst();
         }
      );
   }
