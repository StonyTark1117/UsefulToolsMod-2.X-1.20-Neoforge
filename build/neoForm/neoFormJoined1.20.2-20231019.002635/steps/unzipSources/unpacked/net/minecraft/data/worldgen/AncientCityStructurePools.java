...
public class AncientCityStructurePools {
   public static void bootstrap(BootstapContext<StructureTemplatePool> p_255672_) {
      HolderGetter<PlacedFeature> holdergetter = p_255672_.lookup(Registries.PLACED_FEATURE);
      Holder<PlacedFeature> holder = holdergetter.getOrThrow(CavePlacements.SCULK_PATCH_ANCIENT_CITY);
      HolderGetter<StructureProcessorList> holdergetter1 = p_255672_.lookup(Registries.PROCESSOR_LIST);
      ...
      HolderGetter<StructureTemplatePool> holdergetter2 = p_255672_.lookup(Registries.TEMPLATE_POOL);
