...
public class EntityRenderers {
   ...
   public static Map<PlayerSkin.Model, EntityRenderer<? extends Player>> createPlayerRenderers(EntityRendererProvider.Context p_174052_) {
      ...
      PLAYER_PROVIDERS.forEach((p_295831_, p_234608_) -> {
         try {
            builder.put(p_295831_, p_234608_.create(p_174052_));
         } catch (Exception exception) {
   ...
   static {
      ...
      register(
         ...
         p_174064_ -> new PiglinRenderer(p_174064_, ModelLayers.PIGLIN_BRUTE, ModelLayers.PIGLIN_BRUTE_INNER_ARMOR, ModelLayers.PIGLIN_BRUTE_OUTER_ARMOR, false)
      );
