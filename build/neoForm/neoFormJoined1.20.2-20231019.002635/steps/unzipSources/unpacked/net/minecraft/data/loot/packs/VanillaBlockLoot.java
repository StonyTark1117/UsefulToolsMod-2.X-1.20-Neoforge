   ...
   protected void generate() {
      ...
      this.add(
         ...
         p_250064_ -> LootTable.lootTable()
               .withPool(LootPool.lootPool().add(this.applyExplosionDecay(p_250064_, LootItem.lootTableItem(Items.COMPOSTER))))
               .withPool(
                  LootPool.lootPool()
               ...
               .withPool(
                  this.applyExplosionCondition(
                     ...
                     LootPool.lootPool()
                        .setRolls(ConstantValue.exactly(1.0F))
                        .add(
                           LootItem.lootTableItem(p_250163_)
                              .apply(
      ...
      this.add(
         ...
         p_251177_ -> createSilkTouchDispatchTable(
               p_251177_,
               this.applyExplosionDecay(
                  p_251177_,
      ...
      this.add(
         Blocks.COBWEB,
         p_250546_ -> createSilkTouchOrShearsDispatchTable(p_250546_, this.applyExplosionCondition(p_250546_, LootItem.lootTableItem(Items.STRING)))
      );
      this.add(
         Blocks.DEAD_BUSH,
      ...
      this.add(Blocks.TALL_GRASS, p_251424_ -> this.createDoublePlantWithSeedDrops(p_251424_, Blocks.GRASS));
         ...
         p_249769_ -> LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ConstantValue.exactly(1.0F))
                     .add(
                        this.applyExplosionCondition(p_249769_, LootItem.lootTableItem(p_249769_))
                           .when(LootItemEntityPropertyCondition.entityPresent(LootContext.EntityTarget.THIS))
                     )
               )
      );
      this.add(Blocks.FERN, p_250650_ -> this.createGrassDrops(p_250650_));
      this.add(Blocks.GRASS, p_249038_ -> this.createGrassDrops(p_249038_));
      this.add(
         Blocks.GLOWSTONE,
         p_251150_ -> createSilkTouchDispatchTable(
               p_251150_,
               this.applyExplosionDecay(
                  p_251150_,
      ...
      this.add(
         Blocks.MELON,
         p_251856_ -> createSilkTouchDispatchTable(
               p_251856_,
               this.applyExplosionDecay(
                  p_251856_,
      ...
      this.add(
         Blocks.SEA_LANTERN,
         p_250026_ -> createSilkTouchDispatchTable(
               p_250026_,
               this.applyExplosionDecay(
                  p_250026_,
                           ...
                           LootItem.lootTableItem(Items.NETHER_WART)
                              .apply(
                                 SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F))
                                    .when(
                                       LootItemBlockStatePropertyCondition.hasBlockStateProperties(p_250097_)
                     ...
                     .add(
                        AlternativesEntry.alternatives(
                           AlternativesEntry.alternatives(
                                 ...
                                 p_252097_ -> ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.SNOWBALL)
                                          .when(
                           ...
                           AlternativesEntry.alternatives(
                              SnowLayerBlock.LAYERS.getPossibleValues(),
                              p_251216_ -> (LootPoolEntryContainer.Builder<?>)(p_251216_ == 8
      ...
      this.add(
         Blocks.GRAVEL,
         p_248523_ -> createSilkTouchDispatchTable(
               p_248523_,
               this.applyExplosionCondition(
                  p_248523_,
                  ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.FLINT)
                     ...
                     .otherwise(LootItem.lootTableItem(p_248523_))
               )
            )
      );
      this.add(
         ...
         p_248528_ -> createSilkTouchDispatchTable(
               p_248528_,
               this.applyExplosionCondition(p_248528_, LootItem.lootTableItem(Items.CHARCOAL).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F))))
            )
      );
      this.add(
         Blocks.GILDED_BLACKSTONE,
         p_250428_ -> createSilkTouchDispatchTable(
               p_250428_,
               this.applyExplosionCondition(
                  p_250428_,
                  ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.GOLD_NUGGET)
                        ...
                        .when(BonusLevelTableCondition.bonusLevelFlatChance(Enchantments.BLOCK_FORTUNE, 0.1F, 0.14285715F, 0.25F, 1.0F)))
                     .otherwise(LootItem.lootTableItem(p_250428_))
               )
            )
      );
      this.add(
      ...
      this.add(
         ...
         p_252201_ -> createSilkTouchDispatchTable(
               p_252201_,
               ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.AMETHYST_SHARD)
                  ...
                  .otherwise(
                     this.applyExplosionDecay(
                        p_252201_, LootItem.lootTableItem(Items.AMETHYST_SHARD).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F)))
                     )
                  )
            )
      );
                     ...
                     AlternativesEntry.alternatives(
                        ...
                        p_277248_ -> {
                           ...
                           return p_277248_ == 4
                              ...
                              : ((LootPoolSingletonContainer.Builder)((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.PITCHER_POD)
                                       .when(lootitemblockstatepropertycondition$builder1))
                                    .when(lootitemblockstatepropertycondition$builder))
                                 .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F)));
                        }
