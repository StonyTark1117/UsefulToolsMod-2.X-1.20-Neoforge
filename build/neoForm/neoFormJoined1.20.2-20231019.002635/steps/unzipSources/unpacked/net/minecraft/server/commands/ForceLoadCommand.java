...
public class ForceLoadCommand {
   ...
   private static final Dynamic2CommandExceptionType ERROR_TOO_MANY_CHUNKS = new Dynamic2CommandExceptionType(
      (p_137698_, p_137699_) -> Component.translatable("commands.forceload.toobig", p_137698_, p_137699_)
   );
   private static final Dynamic2CommandExceptionType ERROR_NOT_TICKING = new Dynamic2CommandExceptionType(
      (p_137691_, p_137692_) -> Component.translatable("commands.forceload.query.failure", p_137691_, p_137692_)
   );
            ...
            if (j2 == 0) {
               ...
               if (j2 == 1) {
                  p_137686_.sendSuccess(
                     () -> Component.translatable("commands.forceload." + (p_137689_ ? "added" : "removed") + ".single", chunkpos1, resourcekey.location()),
                     true
                  );
               } else {
                  ...
                  p_137686_.sendSuccess(
                     () -> Component.translatable(
                           "commands.forceload." + (p_137689_ ? "added" : "removed") + ".multiple", chunkpos1, resourcekey.location(), chunkpos2, chunkpos3
                        ),
                     true
                  );
               }
