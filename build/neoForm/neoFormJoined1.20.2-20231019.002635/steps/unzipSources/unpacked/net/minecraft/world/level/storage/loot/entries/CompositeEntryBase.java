...
public abstract class CompositeEntryBase extends LootPoolEntryContainer {
   ...
   public static <T extends CompositeEntryBase> Codec<T> createCodec(CompositeEntryBase.CompositeEntryConstructor<T> p_299248_) {
      return RecordCodecBuilder.create(
         p_298970_ -> p_298970_.group(
               ...
               .apply(p_298970_, p_299248_::create)
      );
   }
