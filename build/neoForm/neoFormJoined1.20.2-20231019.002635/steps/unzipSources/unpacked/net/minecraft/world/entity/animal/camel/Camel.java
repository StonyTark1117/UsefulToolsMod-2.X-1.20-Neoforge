...
public class Camel extends AbstractHorse implements PlayerRideableJumping, Saddleable {
   ...
   public SpawnGroupData finalizeSpawn(
      ServerLevelAccessor p_249190_, DifficultyInstance p_251264_, MobSpawnType p_250254_, @Nullable SpawnGroupData p_249259_, @Nullable CompoundTag p_251838_
   ) {
   ...
   @Override
   protected Vector3f getPassengerAttachmentPoint(Entity p_295101_, EntityDimensions p_294765_, float p_294716_) {
      ...
      return new Vector3f(0.0F, f1, f * p_294716_);
   }
