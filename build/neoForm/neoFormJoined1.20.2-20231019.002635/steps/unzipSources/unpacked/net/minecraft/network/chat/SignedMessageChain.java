...
public class SignedMessageChain {
   ...
   public SignedMessageChain.Decoder decoder(ProfilePublicKey p_249122_) {
      ...
      return (p_248061_, p_248062_) -> {
         ...
         if (signedmessagelink == null) {
            ...
            PlayerChatMessage playerchatmessage = new PlayerChatMessage(signedmessagelink, p_248061_, p_248062_, null, FilterMask.PASS_THROUGH);
   ...
   public interface Decoder {
      ...
      static SignedMessageChain.Decoder unsigned(UUID p_251747_) {
         return (p_248069_, p_248070_) -> PlayerChatMessage.unsigned(p_251747_, p_248070_.content());
      }
