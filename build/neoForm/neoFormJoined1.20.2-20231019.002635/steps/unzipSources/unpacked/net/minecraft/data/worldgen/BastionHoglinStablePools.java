...
public class BastionHoglinStablePools {
   public static void bootstrap(BootstapContext<StructureTemplatePool> p_256582_) {
      HolderGetter<StructureProcessorList> holdergetter = p_256582_.lookup(Registries.PROCESSOR_LIST);
      ...
      HolderGetter<StructureTemplatePool> holdergetter1 = p_256582_.lookup(Registries.TEMPLATE_POOL);
