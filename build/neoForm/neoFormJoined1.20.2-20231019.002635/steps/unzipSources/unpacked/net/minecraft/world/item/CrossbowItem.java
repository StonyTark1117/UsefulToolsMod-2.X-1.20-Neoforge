...
public class CrossbowItem extends ProjectileWeaponItem implements Vanishable {
   ...
   private static void shootProjectile(
      Level p_40895_,
      LivingEntity p_40896_,
      InteractionHand p_40897_,
      ItemStack p_40898_,
      ItemStack p_40899_,
      float p_40900_,
      boolean p_40901_,
      ...
      if (!p_40895_.isClientSide) {
         ...
         if (flag) {
            projectile = new FireworkRocketEntity(p_40895_, p_40899_, p_40896_, p_40896_.getX(), p_40896_.getEyeY() - 0.15F, p_40896_.getZ(), true);
         } else {
         ...
         if (p_40896_ instanceof CrossbowAttackMob crossbowattackmob) {
            ...
            Quaternionf quaternionf = new Quaternionf().setAngleAxis((double)(p_40904_ * (float) (Math.PI / 180.0)), vec3.x, vec3.y, vec3.z);
