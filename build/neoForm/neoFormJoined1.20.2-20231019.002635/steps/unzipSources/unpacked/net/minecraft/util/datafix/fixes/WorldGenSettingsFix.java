      ...
      if (optional.equals(Optional.of("customized"))) {
         ...
         switch($$28) {
            ...
            default:
               ...
               dynamic = noise(
                  i, p_17186_, p_17186_.createString(flag2 ? "minecraft:amplified" : "minecraft:overworld"), vanillaBiomeSource(p_17186_, i, flag1, flag3)
               );
         }
      }
            ...
            map.entrySet()
               ...
               .collect(
                  Collectors.toMap(
                     ...
                     p_17222_ -> ((WorldGenSettingsFix.StructureFeatureConfiguration)p_17222_.getValue()).serialize(p_17218_)
                  )
               )
         )
      );
