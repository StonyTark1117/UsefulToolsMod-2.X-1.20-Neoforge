...
public class PrimaryLevelData implements ServerLevelData, WorldData {
   ...
   public static <T> PrimaryLevelData parse(
      ...
      return new PrimaryLevelData(
         ...
         p_78531_.get("SpawnX").asInt(0),
         p_78531_.get("SpawnY").asInt(0),
         p_78531_.get("SpawnZ").asInt(0),
         p_78531_.get("SpawnAngle").asFloat(0.0F),
         i,
         p_78531_.get("DayTime").asLong(i),
         p_78536_.levelDataVersion(),
         ...
         p_78531_.get("removed_features").asStream().flatMap(p_277335_ -> p_277335_.asString().result().stream()).collect(Collectors.toSet()),
   ...
   private void setTagData(RegistryAccess p_78546_, CompoundTag p_78547_, @Nullable CompoundTag p_78548_) {
      ...
      dataresult.get()
         .ifLeft(p_248505_ -> p_78547_.merge((CompoundTag)p_248505_))
