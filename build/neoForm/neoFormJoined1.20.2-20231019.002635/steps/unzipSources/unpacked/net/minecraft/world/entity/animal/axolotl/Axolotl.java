...
public class Axolotl extends Animal implements LerpingModel, VariantHolder<Axolotl.Variant>, Bucketable {
   ...
   public SpawnGroupData finalizeSpawn(
      ServerLevelAccessor p_149132_, DifficultyInstance p_149133_, MobSpawnType p_149134_, @Nullable SpawnGroupData p_149135_, @Nullable CompoundTag p_149136_
   ) {
      boolean flag = false;
   ...
   public static enum Variant implements StringRepresentable {
      ...
      private static Axolotl.Variant getSpawnVariant(RandomSource p_218451_, boolean p_218452_) {
         Axolotl.Variant[] aaxolotl$variant = Arrays.stream(values())
            .filter(p_149252_ -> p_149252_.common == p_218452_)
