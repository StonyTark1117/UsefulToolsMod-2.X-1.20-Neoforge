...
public abstract class BlockRenameFixWithJigsaw extends BlockRenameFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      TypeRewriteRule typerewriterule = this.fixTypeEverywhereTyped(
         ...
         p_145155_ -> p_145155_.updateTyped(
               opticfinder,
               this.getOutputSchema().getChoiceType(typereference, "minecraft:jigsaw"),
               p_145157_ -> p_145157_.update(
                     DSL.remainderFinder(),
                     p_145159_ -> p_145159_.update("final_state", p_145162_ -> DataFixUtils.orElse(p_145162_.asString().result().map(p_145168_ -> {
