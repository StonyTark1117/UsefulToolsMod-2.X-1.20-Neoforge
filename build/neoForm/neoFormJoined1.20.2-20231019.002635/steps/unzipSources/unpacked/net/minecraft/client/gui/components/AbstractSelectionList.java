...
public abstract class AbstractSelectionList<E extends AbstractSelectionList.Entry<E>>
   ...
   protected final E getEntryAtPosition(double p_93413_, double p_93414_) {
      ...
      return p_93413_ < (double)this.getScrollbarPosition() && p_93413_ >= (double)k && p_93413_ <= (double)l && j1 >= 0 && i1 >= 0 && j1 < this.getItemCount()
      ...
      if (!this.isValidMouseClick(p_93422_)) {
         ...
         if (!this.isMouseOver(p_93420_, p_93421_)) {
            ...
            if (e != null) {
               ...
               this.clickedHeader(
                  (int)(p_93420_ - (double)(this.x0 + this.width / 2 - this.getRowWidth() / 2)),
                  (int)(p_93421_ - (double)this.y0) + (int)this.getScrollAmount() - 4
               );
               return true;
            }
         }
