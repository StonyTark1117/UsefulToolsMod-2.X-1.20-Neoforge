...
public class EnchantmentTableParticle extends TextureSheetParticle {
   ...
   public static class NautilusProvider implements ParticleProvider<SimpleParticleType> {
      ...
      public Particle createParticle(
         SimpleParticleType p_106501_,
         ClientLevel p_106502_,
         double p_106503_,
         double p_106504_,
         double p_106505_,
         double p_106506_,
         ...
         EnchantmentTableParticle enchantmenttableparticle = new EnchantmentTableParticle(
            p_106502_, p_106503_, p_106504_, p_106505_, p_106506_, p_106507_, p_106508_
         );
   ...
   public static class Provider implements ParticleProvider<SimpleParticleType> {
      ...
      public Particle createParticle(
         SimpleParticleType p_106522_,
         ClientLevel p_106523_,
         double p_106524_,
         double p_106525_,
         double p_106526_,
         double p_106527_,
         ...
         EnchantmentTableParticle enchantmenttableparticle = new EnchantmentTableParticle(
            p_106523_, p_106524_, p_106525_, p_106526_, p_106527_, p_106528_, p_106529_
         );
         enchantmenttableparticle.pickSprite(this.sprite);
         return enchantmenttableparticle;
      }
