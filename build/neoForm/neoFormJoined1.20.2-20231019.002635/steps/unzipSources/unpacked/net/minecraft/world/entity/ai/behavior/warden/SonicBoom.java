...
public class SonicBoom extends Behavior<Warden> {
   ...
   protected void tick(ServerLevel p_217724_, Warden p_217725_, long p_217726_) {
      p_217725_.getBrain().getMemory(MemoryModuleType.ATTACK_TARGET).ifPresent(p_301825_ -> p_217725_.getLookControl().setLookAt(p_301825_.position()));
      if (!p_217725_.getBrain().hasMemoryValue(MemoryModuleType.SONIC_BOOM_SOUND_DELAY)
         ...
         p_217725_.getBrain()
            ...
            .ifPresent(p_217704_ -> {
               Vec3 vec3 = p_217725_.position().add(0.0, 1.6F, 0.0);
