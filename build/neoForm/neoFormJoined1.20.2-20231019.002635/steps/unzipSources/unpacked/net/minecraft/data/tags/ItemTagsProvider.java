...
public abstract class ItemTagsProvider extends IntrinsicHolderTagsProvider<Item> {
   ...
   public ItemTagsProvider(PackOutput p_275343_, CompletableFuture<HolderLookup.Provider> p_275729_, CompletableFuture<TagsProvider.TagLookup<Block>> p_275322_, String modId, @javax.annotation.Nullable net.neoforged.neoforge.common.data.ExistingFileHelper existingFileHelper) {
