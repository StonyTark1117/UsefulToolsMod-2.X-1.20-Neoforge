...
public class RandomSequences extends SavedData {
   ...
   public static SavedData.Factory<RandomSequences> factory(long p_294688_) {
      return new SavedData.Factory<>(() -> new RandomSequences(p_294688_), p_293846_ -> load(p_294688_, p_293846_), DataFixTypes.SAVED_DATA_RANDOM_SEQUENCES);
   }
   ...
   public CompoundTag save(CompoundTag p_287658_) {
      ...
      this.sequences
         .forEach(
            (p_287627_, p_287578_) -> compoundtag.put(p_287627_.toString(), RandomSequence.CODEC.encodeStart(NbtOps.INSTANCE, p_287578_).result().orElseThrow())
         );
