...
public class Ghast extends FlyingMob implements Enemy {
   ...
   protected void registerGoals() {
      ...
      this.targetSelector
         .addGoal(1, new NearestAttackableTargetGoal<>(this, Player.class, 10, true, false, p_301893_ -> Math.abs(p_301893_.getY() - this.getY()) <= 4.0));
   }
   ...
   @Override
   protected Vector3f getPassengerAttachmentPoint(Entity p_296376_, EntityDimensions p_294613_, float p_295943_) {
      return new Vector3f(0.0F, p_294613_.height + 0.0625F * p_295943_, 0.0F);
   }

   @Override
   protected float ridingOffset(Entity p_296435_) {
      return 0.5F;
   }
