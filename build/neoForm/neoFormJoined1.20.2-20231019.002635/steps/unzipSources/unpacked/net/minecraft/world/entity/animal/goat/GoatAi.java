...
public class GoatAi {
   ...
   private static final TargetingConditions RAM_TARGET_CONDITIONS = TargetingConditions.forCombat()
      .selector(p_302199_ -> !p_302199_.getType().equals(EntityType.GOAT) && p_302199_.level().getWorldBorder().isWithinBounds(p_302199_.getBoundingBox()));
         ...
         ImmutableList.of(
            Pair.of(
               ...
               new RamTarget(
                  ...
                  3.0F,
                  p_301881_ -> p_301881_.isBaby() ? 1.0 : 2.5,
