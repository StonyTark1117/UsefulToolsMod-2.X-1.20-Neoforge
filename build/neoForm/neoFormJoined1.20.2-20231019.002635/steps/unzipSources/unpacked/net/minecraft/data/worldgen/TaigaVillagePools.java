...
public class TaigaVillagePools {
   ...
   public static void bootstrap(BootstapContext<StructureTemplatePool> p_256442_) {
      HolderGetter<PlacedFeature> holdergetter = p_256442_.lookup(Registries.PLACED_FEATURE);
      ...
      HolderGetter<StructureProcessorList> holdergetter1 = p_256442_.lookup(Registries.PROCESSOR_LIST);
      ...
      HolderGetter<StructureTemplatePool> holdergetter2 = p_256442_.lookup(Registries.TEMPLATE_POOL);
