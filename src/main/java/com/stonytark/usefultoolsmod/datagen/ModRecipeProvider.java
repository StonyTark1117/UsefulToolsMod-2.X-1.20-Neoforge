...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(RecipeOutput pRecipeOutput) {
        List<ItemLike> RGOLD_SMELTABLES = List.of(ModBlocks.RGOLDORE.get(), ModBlocks.RGOLD_END_ORE.get(), ModBlocks.RGOLD_NETHER_ORE.get(), ModBlocks.RGOLD_DEEPSLATE_ORE.get());
