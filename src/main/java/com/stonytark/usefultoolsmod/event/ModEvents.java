...
public class ModEvents {
    ...
    public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
        ...
        // Handle armor glow — in 1.20.2, getMaterial() returns ArmorMaterial directly (not Holder)
        for (ItemStack armorStack : player.getArmorSlots()) {
            if (armorStack.getItem() instanceof ArmorItem armor) {
                if (armor.getMaterial() == ModArmorMaterials.OVERPOWER && player.level().isClientSide()) {
